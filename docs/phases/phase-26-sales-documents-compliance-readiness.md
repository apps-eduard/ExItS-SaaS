...
**OPEN** — P26-WP01–WP06 Code Complete / Owner Validation Pending (WP06 also Regulatory Validation Pending). This is not a phase closeout. Phase 25 remains **OPEN** with owner validation pending. Owner validation and future regulatory confirmation remain outstanding.
...
| P26-WP06 | BIR registration profile & activation readiness (domain/API + Org Web/Admin/MAUI UI + docs) | Code Complete / Owner + Regulatory Validation Pending |
...
- Compliance profile may store registered taxpayer name and normalized TIN; DTOs expose **MaskedTin** only. Branch compliance profiles are separate. Registration AcceptForReadiness is ExItS readiness — not BIR certification.
- UI must not claim “BIR Compliant”, “BIR Certified”, or “BIR Accredited”.

## Explicit exclusions

WP01–WP06 do not implement BIR rules, invoice series, TaxDocument generation, or compliance certification. No ExItS UI claims BIR compliance. WP06 does not close Phase 26. `TaxDocumentIssuanceRuntime.ImplementationAvailable` remains **false**.

Privacy inventory for education acknowledgment, eligibility, profile (incl. TIN), registration readiness, and future evidence principles: [P21-WP11](../reports/P21-WP11-post-phase21-privacy-impact-refresh.md) / [post-phase21-privacy-impact-refresh.md](../compliance/post-phase21-privacy-impact-refresh.md) (Phase 21 remains **OPEN**; NPC compliance **not claimed**).
...
[authoritative source register](../compliance/bir-authoritative-source-register.md),
...
[P26-WP05 report](../reports/P26-WP05-sales-document-compliance-integration-hardening.md), and
[P26-WP06 report](../reports/P26-WP06-bir-registration-profile-and-activation-readiness.md).
