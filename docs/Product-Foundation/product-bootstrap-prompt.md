...
Do not scan: PinoyBusinessPOS / other products, `docs/reports/` history, full Platform, all migrations/tests, unauthorized nested product content, build artifacts.
