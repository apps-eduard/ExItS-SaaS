...
P16-WP05 ✓ Personal Utang Core
        ↓
P16-WP06 ○ Invitations, Linking, Reminders, Notifications (next)
        ↓
P16-WP07…P16-WP10 ○ (authorized; do not skip ahead)
```
...
**Phase 16 Account Profiles / Personal Utang:** 5 / 10 WPs complete (through P16-WP05; Phase 14 unchanged).
