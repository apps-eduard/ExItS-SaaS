...
- **Phases 19–28:** Implementation slices exist at varying completeness; owner/device/browser verification and closeouts remain open where noted on each phase page. Phase 28 Personal linked-merchant storefront/cart, manual CustomerOrder payment method, product images (including shared Platform template images + org overrides), customer-facing available stock, **P28-WP12 multi-branch commerce hardening**, and **P28-WP13 branch operational context + owner switching** are Code Complete / Validation Pending; Branch Edit UX densification is Code Complete / Validation Pending; MAUI list-load performance (customers/catalog/sell first paint + sign-in org bind) is Code Complete / Validation Pending; automated settlement rails remain residual; **P28-WP10** E2E/closeout remains next.
