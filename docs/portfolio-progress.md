...
[Documentation Home](index.md) | [Approved architecture](engineering/approved-architecture-summary.md) | [P7-WP04 report](reports/P7-WP04-payment-sync-and-recovery.md)
...
P7-WP04 ✓ Payment Sync and Recovery (complete with risks)
        ↓
P7-WP05 — Offline Closeout (not started — do not begin until authorized)
```
...
| 7 | Offline Synchronization | **In Progress** | 4 | 5 | 80% | [Open](phases/phase-07-offline-sync.md) |
