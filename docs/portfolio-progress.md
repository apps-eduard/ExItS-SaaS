...
P16-WP07 ✓ Organization Staff and Customer Separation
        ↓
P16-WP08 ○ Start a Business and Utang Migration (next)
        ↓
P16-WP09…P16-WP10 ○ (authorized; do not skip ahead)
```
...
| 16 | Isolated Account Profiles, Personal Utang, Business Upgrade | **In progress** | 7 | 10 | 70% | [Open](phases/phase-16-isolated-account-profiles-personal-utang-and-business-upgrade.md) |
...
**Phase 16 Account Profiles / Personal Utang:** 7 / 10 WPs complete (through P16-WP07; Phase 14 unchanged).
