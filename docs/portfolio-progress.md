...
[Documentation Home](index.md) | [Approved architecture](engineering/approved-architecture-summary.md) | [P5-WP04 report](reports/P5-WP04-reusable-mvp-components.md)
...
P5-WP04 Reusable MVP Components ✓
        ↓
P5-WP05 — Authentication, Onboarding and Closeout (not started — do not begin until authorized)
```
...
| 5 | PinoyBusinessPOS MAUI Foundation | **In Progress** | 4 | 5 | 80% | [Open](phases/phase-05-pos-maui-foundation.md) |
