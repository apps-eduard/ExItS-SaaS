...
| Current work package | P12-WP04 — Cursor Product Context Rule (**complete**) |
| Overall status | **Phase 12 in progress.** P12-WP01–WP04 complete. Product context Cursor rule published. Exact next: P12-WP05 — Product Bootstrap Prompt (do not begin until authorized). **Not production-ready.** |
| Latest verified commit | `1243c78d65e347b23949b19ce2edf564fe972aad` |
...
P12-WP04 ✓ Cursor Product Context Rule
        ↓
P12-WP05 ○ Product Bootstrap Prompt (do not begin until authorized)
```
...
| 12 | Reusable SaaS Product Foundation and Bootstrap | **In progress** | 4 | 7 | — | [Open](phases/phase-12-product-foundation-and-bootstrap.md) |
...
| P12-WP04 — Cursor Product Context Rule | Complete | *(tip filled after commit)* |
...
Follow `.cursor/rules/exits-workflow.mdc`. Do not begin **P12-WP05** until explicitly authorized.
