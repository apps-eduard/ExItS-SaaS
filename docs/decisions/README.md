...
| ADR-004 | Keep Ant Design in **existing HealthCare Staff Web**; Platform Admin Ant adoption is ADR-015 | Accepted — detail in [ADR-010](ADR-010-separate-ui-implementations-platform-and-pos.md) / [ADR-015](ADR-015-antdesign-blazor-platform-admin.md) |
