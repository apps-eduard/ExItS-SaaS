...
23. **P4-WP03:** Subscription and manual SaaS payment Admin mutations remain unauthenticated. Manual confirmation is not provider verification. No card numbers, CVV, PIN, OTP, gateway SDKs, webhooks, or invoice engines. Subscription changes do not deliver entitlements or assign product-local roles.
