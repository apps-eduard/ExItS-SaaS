...
27. **P6-WP03:** Repayments are organization-scoped; actor captured via Development/Testing `X-Dev-Platform-User-Id`. Overpayment is rejected in a serializable transaction. Unified ledger is read-only. No due dates, statements, or receipts yet.
