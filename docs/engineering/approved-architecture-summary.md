...
| Next WP | **P12-WP05 — Product Bootstrap Prompt** (not started; requires authorization). P12-WP01–WP04 complete. | [Phase 12](../phases/phase-12-product-foundation-and-bootstrap.md) · [product context rule](../../.cursor/rules/exits-product-context.mdc) |
