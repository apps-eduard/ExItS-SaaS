...
| Next WP | **P12-WP04 — Cursor Product Context Rule** (not started; requires authorization). P12-WP01–WP03 complete. | [Phase 12](../phases/phase-12-product-foundation-and-bootstrap.md) · [Templates](../Product-Foundation/Templates/README.md) |
