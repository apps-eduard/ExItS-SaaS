...
[Capability boundary](platform-product-capability-boundary.md) | [Data ownership](data-ownership.md)
...
| Membership | Platform | MembershipId | Products (access) | Role codes for access | Platform | Platform | Platform |
| Product | Platform | ProductCode | All | Name, status | Platform | Platform | Platform |
| Plan | Platform | PlanCode + version | Products | Limits/features list | Platform | Platform | Platform |
...
| SaaS payment | Platform | PaymentId | Admin, org billing UI | Status, reference | Platform | Platform | Platform |
...
| Store / branch | POS | StoreId | POS | — | POS | POS | POS |
| Customer | POS | CustomerId | POS; optional UserId later | — | POS | POS | POS |
| CustomerCredit / entries / payments | POS | CreditId / EntryId / PaymentId | POS | — | POS | POS | POS |
| Catalog product / barcode | POS | ProductId | POS | — | POS | POS | POS |
...
| Entitlement projection row | Product | (OrgId, ProductCode, Version) | Product runtime | Copy of Platform snapshot | Product apply from Platform events | Product (+ Platform source) | Product |

**Replication:** Platform → product projections only for commercial/identity facts needed locally. No product → Platform replication of operational domain data. No cross-DB FKs.
