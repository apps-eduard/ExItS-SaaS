...
|---|---|---|---|---|---|
| G0 Docs freeze | P1-WP01–03 accepted; legacy product `git ls-files` empty | Portfolio | Stage 1 code | L0 | **Met** |
| G1 Solution foundation | Solution builds; architecture dependency tests; no legacy product import | Platform eng | Stage 2 | L1 plan | **Met** (P2-WP01) |
...
| G6 Mapping dry run | Mapping report; collision report; reversible audit trail | Platform + legacy product | legacy product adapter enable | L3/L5 backups verified | **Partial (P2-WP05)** — Platform dry-run only |
| G7 legacy product regression | 1102 safe suite (or successor); Integration/E2E in supported env | legacy product eng | Any legacy product cutover | L5 restore rehearsal pass | **Not started** (1102 not rerun in Phase 2) |
...
| G10 POS readiness | IDs, ProductCode, entitlement contracts, Cash/GCash/Utang, native UI, offline ownership | Portfolio | Phase 5 POS code | N/A (POS independent of legacy product cutover) | **Not started** |
