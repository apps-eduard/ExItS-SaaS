...
| G4 Catalog / entitlements | Contract version/idempotency/out-of-order/unsupported major tests | Platform eng | Stage 5 / POS gate | L4 plan reviewed | **Partial** — domain + contracts; no billing persistence |
