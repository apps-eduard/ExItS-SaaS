...
### PinoyBusinessPOS resources (P5-WP01–P6-WP03)
...
Includes shell/home/settings/auth keys plus **Customers_***, **Credit_***, **Payment_***, **Ledger_***, and **Utang_*** deferred-feature strings.
