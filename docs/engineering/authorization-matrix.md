...
**P6-WP01 / P6-WP02 note:** POS customer and credit routes require `X-Pos-Organization-Id`. Cross-organization access returns 404. Product-local Cashier/Store roles are still not implemented. Development/Testing Platform identity remains the MAUI auth path.
