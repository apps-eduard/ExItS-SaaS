...
**Work package:** P1-WP02 (ownership docs); **P2-WP02** identity; **P2-WP03** commercial; **P2-WP04** outbound HC projection contracts (Platform-side only); **P2-WP05** migration dry-run validation (no real migration); **P3-WP02** organization + subscription persistence; **P4-WP02** Platform users, organization memberships, and product-access assignments (no product-local roles).
