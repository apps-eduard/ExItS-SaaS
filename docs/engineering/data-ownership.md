...
**Work package:** P1-WP02 (ownership docs); **P2-WP02** identity aggregates; **P2-WP03** commercial catalog/entitlement aggregates (no persistence yet).
**Status:** Authoritative ownership + projection rules (documentation); identity and commercial domain models exist in code
