# POS React — Personal + Business QR / Public ID Linking Parity
...
- React device-registration code UX **removed** (prior package) — unchanged
...
| Customer create → resolve → confirm → `with-personal-link` | Added |
...
- Pending CustomerLinkRequest → Personal Accept
