...
| REACT | Full vitest | 1354/1354 | PASS | BUILD_VALIDATION | POS-BRANCH-FULFILLMENT-UI-CLOSURE-01 | `5aeb07ce` | `5aeb07ce` | Fulfillment UI closure + P1 capability forward | NO | Permanent React baseline after P1 | CURRENT_RUN |
...
| FULFILLMENT | Branch list switches + setup tabs UI | FUL-UI-01/02 live | PASS | MANUAL_UI | POS-BRANCH-FULFILLMENT-UI-CLOSURE-01 | `5aeb07ce` | `5aeb07ce` | Auth UI closed | NO | Not unless fulfillment UI changes | CURRENT_RUN |
| FULFILLMENT | Coord-only save preserves address UI | FUL-UI-03 | PASS | MANUAL_UI | UI-CLOSURE-01 | `5aeb07ce` | `5aeb07ce` | BUG_FULFILLMENT_01 regression | NO | — | CURRENT_RUN |
| FULFILLMENT | Delivery areas add/dup/remove UI | FUL-UI-04 | PASS | MANUAL_UI | UI-CLOSURE-01 | `5aeb07ce` | `5aeb07ce` | — | NO | — | CURRENT_RUN |
| FULFILLMENT | Personal checkout area selector + quote | FUL-UI-05 | PASS | MANUAL_UI | UI-CLOSURE-01 | `5aeb07ce` | `5aeb07ce` | BUG_FULFILLMENT_03 | NO | — | CURRENT_RUN |
| FULFILLMENT | Responsive 360/768/1440 fulfillment pages | FUL-UI-06/07/08 | PASS | MANUAL_UI | UI-CLOSURE-01 | `5aeb07ce` | `5aeb07ce` | Actual fulfillment routes | NO | — | CURRENT_RUN |
