...
| Sale-line price override | Role-gated per-sale UnitPrice; never catalog | PROVEN_CURRENT | PROVEN_CURRENT | PROVEN_CURRENT (UI) | CURRENT | CURRENT | RMAP-B01 + RMAP-12b | — | Cashier DENY; Manager ≤100%; Owner unlimited; CashierAdjustable SUPERSEDED |
