...
| Checkout cash sale (RMAP-11) | pos-sales-client + cart map + error map | | | `/sell/checkout`, `/sell/sales/:id/summary` | E2E 9/9: device gate, success disclaimer, failure keep cart, idempotent saleId, blocked gate + 375/768/1024/1440 | N/A | CreateSale + moneyPostReady | Org + branch + installation device | Browser + viewports | PASS | Cash only; no discount UX; no GCash/Utang/Card |
