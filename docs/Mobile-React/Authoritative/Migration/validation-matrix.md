...
| Inventory (RMAP-07) | InventoryEndpoints + PosInventoryApiTests 7/7 | InventoryAccountDomainTests 9/9 | | `/inventory*` | E2E 8/8: untracked/enable0/enable+/in/out/disable rules + deny | N/A | View/ManageInventory | Not tracked ≠ zero; disable requires zero | 375/768/1024/1440 list+detail | PASS — validation closeout | Lots RMAP-08 excluded |
