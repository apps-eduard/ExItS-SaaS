...
| Today's Prices (RMAP-06) | prices endpoint | | | `/catalog/todays-prices` | E2E dirty save + cashier deny | N/A | ManageCatalog | required ExpectedUpdatedAtUtc | Phone sticky save | PASS | Override excluded |
| Inventory (RMAP-07) | InventoryEndpoints | | | `/inventory*` | E2E untracked/enable/adjust + deny | N/A | View/ManageInventory | Not tracked ≠ zero | Phone list/detail | PASS | Lots RMAP-08 excluded |
