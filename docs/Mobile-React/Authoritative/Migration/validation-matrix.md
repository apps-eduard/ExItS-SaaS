...
| Staff person-link backend (RMAP-B00) | Person-link + accept-as-personal | Anonymous no-Personal preserved | MAUI compat path | N/A | N/A | N/A | Membership on staff only | Multi-org + removal | N/A | Owner Option C checklist | COMPLETE; Repair 02 |
