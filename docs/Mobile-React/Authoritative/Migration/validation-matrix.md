...
| Sell floor + cart (RMAP-09) | Session cart helpers | | | units/weight dialogs; stock advisory | E2E 7/7: multi-UOM, ByWeight, barcode, clear, 375/768/1024/1440 | N/A | CreateSale UI gate later | Org via workspace | Browser + viewports | PASS | Pay/checkout + camera barcode + FEFO excluded |
