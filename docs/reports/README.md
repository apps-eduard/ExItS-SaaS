...
| [personal-organization-identity-isolation.md](personal-organization-identity-isolation.md) | Personal / Organization identity QR isolation (envelope, device tokens, org switch) | Code Complete (SHAs pending parent; Device Verified No) |
| [organization-profile-independence.md](organization-profile-independence.md) | Organization profile independent of Personal (one-time copy, multi-org owner, one owner/org) | Code Complete (Device Verified No) |
| [sales-buyer-party-isolation.md](sales-buyer-party-isolation.md) | POS sale buyer parties + QR purpose matrix (seller owns sale) | Code Complete (SHAs pending; Device Verified No) |
