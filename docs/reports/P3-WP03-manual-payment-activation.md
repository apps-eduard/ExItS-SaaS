...
| Excluded tables | POS payments, Utang payments, invoices, cards, webhooks, gateway tokens |
...
Confirmed absent: gateway, webhook, QR, card, POS, Utang, and invoice routes.
