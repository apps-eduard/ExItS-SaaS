...
| Mandatory offline PIN enrollment after Personal online login (same as Org POS) | Code complete · device incomplete — complete readiness (grant + device + verifier), not verifier-only |
