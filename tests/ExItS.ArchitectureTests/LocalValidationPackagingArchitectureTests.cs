...
public sealed class LocalValidationPackagingArchitectureTests
{
    ...
    public void Local_validation_compose_is_separate_project_with_admin_and_distinct_ports()
    {
        ...
        Assert.Contains("Get-LocalValidationDockerComposeLabel", stackScript, StringComparison.Ordinal);
        ...
        Assert.Contains("Freeing $($svc.Label) port $port before partial start", startScript, StringComparison.Ordinal);
