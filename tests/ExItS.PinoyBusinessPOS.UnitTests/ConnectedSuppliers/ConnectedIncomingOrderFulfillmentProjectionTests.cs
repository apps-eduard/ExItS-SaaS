...
public sealed class ConnectedIncomingOrderFulfillmentProjectionTests
{
    ...
    public void Partial_receipt_projects_good_damaged_and_outstanding_per_line()
    {
        ...
        Assert.Equal("GRN-260917-001", latest.GrnNumber);
    ...
    public void Cumulative_receipts_reduce_outstanding_and_exclude_voided()
    {
        ...
        var grn1 = GoodsReceipt.Create(
            Buyer, po.Id, "GRN-260917-001", po, first, Actor, Now.AddMinutes(10), receivingBranchId: Branch);
        ...
        var grn2 = GoodsReceipt.Create(
            Buyer, po.Id, "GRN-260917-002", po, second, Actor, Now.AddMinutes(20), receivingBranchId: Branch);
        ...
        var voided = GoodsReceipt.Create(
            Buyer, po.Id, "GRN-260917-099", po, voidedDraft, Actor, Now.AddMinutes(5), receivingBranchId: Branch);
        ...
        Assert.Equal("GRN-260917-002", receipts[0].GrnNumber);
    ...
    public void Damaged_does_not_count_as_good_received()
    {
        ...
        po.ApplyReceiptLines(receive, Now.AddMinutes(10));
        var grn = GoodsReceipt.Create(
            Buyer, po.Id, "GRN-260917-010", po, receive, Actor, Now.AddMinutes(10), receivingBranchId: Branch);
    ...
    public void Missing_rejected_qty_is_projected_separately()
    {
        ...
        po.ApplyReceiptLines(receive, Now.AddMinutes(10));
        var grn = GoodsReceipt.Create(
            Buyer, po.Id, "GRN-260917-011", po, receive, Actor, Now.AddMinutes(10), receivingBranchId: Branch);
        ...
        bool includeBanana = true)
    {
        ...
        var po = PurchaseOrder.CreateDraft(
            ...
            drafts,
            Now);
        po.Submit("PO-260917-042", snapshots, Actor, Now.AddMinutes(1));
        return (order, po);
    }
}
