...
public sealed class CashierShiftDomainTests
{
    ...
    {
        var shift = CashierShift.Open(Org, "SH-260731-001", Actor, Register, 500m, Now);
        Assert.Equal(CashierShiftStatus.Open, shift.Status);
        Assert.Equal("SH-260731-001", shift.ShiftNumber);
    ...
    {
        var shift = CashierShift.Open(Org, "SH-260731-001", Actor, Register, 100m, Now);
    ...
    {
        var shift = CashierShift.Open(Org, "SH-260731-001", Actor, Register, 0m, Now);
    ...
    public void Negative_opening_cash_rejected()
    {
        var ex = Assert.Throws<DomainException>(() =>
            CashierShift.Open(Org, "SH-260731-001", Actor, Register, -1m, Now));
    ...
    {
        var shift = CashierShift.Open(Org, "SH-260731-001", Actor, Register, null, Now, cashCountMode: CashCountMode.Off);
    ...
    {
        var counted = CashierShift.Open(Org, "SH-260731-001", Actor, Register, 1000m, Now, cashCountMode: CashCountMode.Optional);
        Assert.True(counted.OpeningCashCounted);
        Assert.Equal(1000m, counted.OpeningCashAmount);

        var skipped = CashierShift.Open(Org, "SH-260731-002", Actor, Register, null, Now, cashCountMode: CashCountMode.Optional);
    ...
    {
        var shift = CashierShift.Open(Org, "SH-260731-001", Actor, Register, 100m, Now, cashCountMode: CashCountMode.Optional);
    ...
    public void Required_mode_rejects_missing_opening_and_closing_count()
    {
        var openEx = Assert.Throws<DomainException>(() =>
            CashierShift.Open(Org, "SH-260731-001", Actor, Register, null, Now, cashCountMode: CashCountMode.Required));
        Assert.Equal(DomainErrorCodes.CashierShiftOpeningCashCountRequired, openEx.ErrorCode);

        var shift = CashierShift.Open(Org, "SH-260731-001", Actor, Register, 0m, Now, cashCountMode: CashCountMode.Required);
    ...
    {
        var shift = CashierShift.Open(Org, "SH-260731-001", Actor, Register, 50m, Now, cashCountMode: CashCountMode.Required);
    ...
    {
        var shift = CashierShift.Open(Org, "SH-260731-001", Actor, Register, null, Now, cashCountMode: CashCountMode.Optional);
    ...
    {
        var countedZero = CashierShift.Open(Org, "SH-260731-001", Actor, Register, 0m, Now, cashCountMode: CashCountMode.Optional);
