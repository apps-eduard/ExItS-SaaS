...
public sealed class CashierShiftDomainTests
{
    ...
    {
        var shift = CashierShift.Open(Org, "shift-20260731-000001", Actor, 500m, Now);
    ...
    {
        var shift = CashierShift.Open(Org, "SHIFT-20260731-000001", Actor, 100m, Now);
    ...
    {
        var shift = CashierShift.Open(Org, "SHIFT-20260731-000001", Actor, 0m, Now);
    ...
    public void Negative_opening_cash_rejected()
    {
        var ex = Assert.Throws<DomainException>(() =>
            CashierShift.Open(Org, "SHIFT-20260731-000001", Actor, -1m, Now));
