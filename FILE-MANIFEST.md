...
Markdown documentation files plus root Platform foundation through Phase 8 Basic Store (P8-WP01 Catalog and Barcode + P8-WP02 Simple Sales complete with documented risks; Phase 8 in progress).
Internal links checked: spot-check P8-WP02
...
src/Products/PinoyBusinessPOS/ExItS.PinoyBusinessPOS.Api/ (`/health` + customers + credit + repayments/ledger + due dates/overdue + statements/receipts + catalog + sales; commercial header gates; phase marker `P8-WP02-simple-sales`)
