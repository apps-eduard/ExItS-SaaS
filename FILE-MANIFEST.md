...
src/Platform/ExItS.Platform.Admin.Web/ (React + TypeScript + Vite Platform Admin Web; design-system and preference foundation as of PWEB-IMPL-02; consumes Platform API; does not replace Blazor Admin until cutover)
