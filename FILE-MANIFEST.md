...
src/Products/PinoyBusinessPOS/ExItS.PinoyBusinessPOS.Client/ (React Mobile Client host; Gate C/D shell + IMPL-02A product chrome + IMPL-03A same-origin cookie Sign In; not workspace/PIN/Capacitor/selling)
