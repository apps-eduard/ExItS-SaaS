...
src/Products/PinoyBusinessPOS/ExItS.PinoyBusinessPOS.Client/ (React Mobile Client host; Gate C shell + Gate D PWA static shell + IMPL-03A same-origin `/platform-api` cookie Sign In; not workspace/PIN/Capacitor/selling)
