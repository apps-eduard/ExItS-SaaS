...
src/Products/PinoyBusinessPOS/ExItS.PinoyBusinessPOS.Client/ (future React + TypeScript Vite host for browser / PWA / later Capacitor; Gate C foundation shell only on `feat/pos-react-client`; MAUI remains active)
