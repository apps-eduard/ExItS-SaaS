// Shared ExItS browser theme boot (Platform Admin, Organization Web, Personal Web).
// Persisted preference: light | dark | system.
(function () {
    "use strict";
    var THEME_KEY = "exits-web-theme";
    var CULTURE_KEY = "exits-web-culture";
    ...
    function attachBlazorEnhancedLoad() {
        ...
        if (window.__exitsWebThemeEnhancedBound) {
            return true;
        }
        window.Blazor.addEventListener("enhancedload", function () {
            readAndApplyTheme();
        });
        window.__exitsWebThemeEnhancedBound = true;
        return true;
    }
