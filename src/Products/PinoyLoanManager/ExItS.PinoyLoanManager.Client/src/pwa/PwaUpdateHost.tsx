...
export const PLM_PWA_NEED_REFRESH_EVENT = "plm:pwa-need-refresh";
...
export function PwaUpdateHost() {
  ...
  useEffect(() => {
    ...
    window.addEventListener(PLM_PWA_NEED_REFRESH_EVENT, showNotice);
    setListening(true);
    ...
    return () => {
      cancelled = true;
      window.removeEventListener(PLM_PWA_NEED_REFRESH_EVENT, showNotice);
    };
  }, []);
