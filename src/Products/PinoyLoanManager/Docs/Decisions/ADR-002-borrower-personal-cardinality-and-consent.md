...
7. Relink requires a new request and new consent. Changing Personal identity on a Borrower is a high-risk correction (maker/checker and Owner Override later closed in [ADR-008](ADR-008-reversals-refunds-variance-and-accounting-boundary.md); **PLM-D-00-13 Closed**).
