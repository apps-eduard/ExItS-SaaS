...
| PLM-00-WP04 | Financial calculation and loan lifecycle baseline | Completed |
| PLM-00-WP05 | Authorization, cash control, and operational workflow baseline | Current |
| PLM-00-WP06 | Borrower, Personal linking, and Quick Loan publishing baseline | Next proposed |

WP06 remains documentation / product planning. No implementation phase is authorized yet.
