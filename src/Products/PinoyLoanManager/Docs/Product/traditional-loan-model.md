...
Traditional Loan MVP may use **Flat / Add-On** or **Reducing-Balance Equal-Installment**. Reducing-balance supports Added To Repayment only. Canonical: [interest-and-finance-charge-policy.md](interest-and-finance-charge-policy.md).
