...
**Status:** PLM-00 accepted; PLM-01 product shell scaffolded; PLM-01A client architecture approved (PLM-D-00-09); Gates B, C, D0, and D1 complete
**Implementation present:** Product shell + React Client + online-first PWA + cookie Sign In/session UI — no Register/Reset; no lending; no Capacitor
