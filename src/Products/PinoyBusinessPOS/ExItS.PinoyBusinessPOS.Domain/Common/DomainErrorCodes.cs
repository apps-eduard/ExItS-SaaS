...
public static class DomainErrorCodes
{
    ...
    public const string InvalidReturnBatchId = "pos.return_batch.id.invalid";
    public const string InvalidReturnBatchLineId = "pos.return_batch_line.id.invalid";
    public const string InvalidReturnBatchNumber = "pos.return_batch.number.invalid";
    public const string InvalidReturnBatchStatus = "pos.return_batch.status.invalid";
    public const string InvalidReturnBatchRefundStatus = "pos.return_batch.refund_status.invalid";
    public const string InvalidReturnBatchReason = "pos.return_batch.reason.invalid";
    public const string InvalidReturnBatchLine = "pos.return_batch_line.invalid";
    public const string InvalidReturnBatchClassification = "pos.return_batch.classification.invalid";
    public const string InvalidReturnBatchAcceptedValue = "pos.return_batch.accepted_value.invalid";
    public const string InvalidReturnBatchRefundAmount = "pos.return_batch.refund_amount.invalid";
    public const string ReturnBatchRequiresAtLeastOneLine = "pos.return_batch.lines.required";
    public const string ReturnBatchSaleNotReturnable = "pos.return_batch.sale_not_returnable";
    public const string ReturnBatchQuantityExceedsRefundable = "pos.return_batch.quantity.exceeds_refundable";
    public const string ReturnBatchLineNotFound = "pos.return_batch.line_not_found";
    public const string ReturnBatchNotReadyForFinalize = "pos.return_batch.not_ready_for_finalize";
    public const string ReturnBatchAlreadyFinalized = "pos.return_batch.already_finalized";
    public const string InvalidReturnBatchRefundId = "pos.return_batch.refund.id.invalid";
    public const string InvalidReturnBatchRefundMethod = "pos.return_batch.refund.method.invalid";
    public const string InvalidReturnBatchRefundReference = "pos.return_batch.refund.reference.invalid";
    public const string InvalidReturnBatchRefundNote = "pos.return_batch.refund.note.invalid";
    public const string InvalidReturnBatchRefundClientId = "pos.return_batch.refund.client_id.invalid";
    public const string ReturnBatchRefundNotAllowed = "pos.return_batch.refund.not_allowed";
    public const string ReturnBatchRefundExceedsRemaining = "pos.return_batch.refund.exceeds_remaining";
    public const string InvalidReturnBatchAuditEventType = "pos.return_batch.audit.event_type.invalid";
    public const string InvalidReturnBatchSourceType = "pos.return_batch.source_type.invalid";
    public const string ReturnBatchSourceMismatch = "pos.return_batch.source_mismatch";
    public const string ReturnBatchPurchaseOrderNotReturnable = "pos.return_batch.purchase_order_not_returnable";
