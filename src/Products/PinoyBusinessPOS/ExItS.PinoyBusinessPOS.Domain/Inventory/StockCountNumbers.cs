...
/// <summary>
/// Organization-scoped stock count number: <c>SC-YYMMDD-NNN</c>.
/// Allocated server-side on count create.
/// </summary>
public static class StockCountNumbers
{
    public const string Prefix = PosDocumentPrefixes.StockCount;
    ...
    public static string Normalize(string? countNumber) =>
        Map(() => PosDocumentNumbers.NormalizeRoot(countNumber, Prefix));
