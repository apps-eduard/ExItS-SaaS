...
export const OFFLINE_OPERATION_TYPES = {
  ...
  SaleReturnFinalize: "sale_return.finalize",
  ...
  InventoryTransferExceptionReceiveReturn: "inventory_transfer.exception_receive_return",
  InventoryTransferExceptionInspect: "inventory_transfer.exception_inspect",
  InventoryTransferDamageDispatchReturn: "inventory_transfer.damage_dispatch_return",
  InventoryTransferDamageReceiveReturn: "inventory_transfer.damage_receive_return",
  InventoryTransferDamageInspect: "inventory_transfer.damage_inspect",
