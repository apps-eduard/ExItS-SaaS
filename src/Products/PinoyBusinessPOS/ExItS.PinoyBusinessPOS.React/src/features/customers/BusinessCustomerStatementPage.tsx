    ...
    <div className="flex min-w-0 flex-col gap-4" data-testid="business-customer-statement-page">
      ...
      >
        <div className="flex min-w-0 flex-wrap gap-3">
          <label
            ...
            htmlFor="business-statement-start"
          >
            {t("customers.periodStart")}
            <input
              id="business-statement-start"
          ...
          <label
            className="flex flex-col gap-1 text-[length:var(--exits-text-sm)]"
            htmlFor="business-statement-end"
          >
            {t("customers.periodEnd")}
            <input
              id="business-statement-end"
      ...
      {statementQuery.data ? (
        <>
          ...
          {statementQuery.data.lines.length === 0 || filteredLines.length === 0 ? (
            <EmptyState
              align="center"
