...
export function PersonalCustomerLinksPage() {
  ...
  async function onAcceptGroup(group: ConsentRequestGroup<PendingCustomerLinkRequestDto>) {
    setActionError(null);
  ...
  async function onDeclineGroup(group: ConsentRequestGroup<PendingCustomerLinkRequestDto>) {
    setActionError(null);
  ...
  async function onBlockGroup(group: ConsentRequestGroup<PendingCustomerLinkRequestDto>) {
    setActionError(null);
    const primaryId = group.primary.id;
    const siblings = siblingRequestIds(primaryId, group.items);
  ...
  return (
    ...
    >
      ...
      {activeQuery.isPending ? (
        ...
        <PendingTabContent
          groupedItems={groupedPendingItems}
...
function PendingTabContent({
  ...
  groupedItems: ConsentRequestGroup<PendingCustomerLinkRequestDto>[];
  actionsDisabled: boolean;
  acceptingId: string | null;
  decliningId: string | null;
  blockingId: string | null;
  onAcceptGroup: (group: ConsentRequestGroup<PendingCustomerLinkRequestDto>) => void;
  onDeclineGroup: (group: ConsentRequestGroup<PendingCustomerLinkRequestDto>) => void;
  onBlockGroup: (group: ConsentRequestGroup<PendingCustomerLinkRequestDto>) => void;
