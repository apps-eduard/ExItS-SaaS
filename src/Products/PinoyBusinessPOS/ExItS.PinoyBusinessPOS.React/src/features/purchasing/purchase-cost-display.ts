...
export function inventoryMovementTypeLabelKey(movementType: string): MessageKey {
  switch (movementType) {
    ...
    case "TransferDamageHold":
      return "inventory.movementType.transferDamageHold";
    case "TransferDamageRecovery":
      return "inventory.movementType.transferDamageRecovery";
    case "TransferDamageReturnOut":
      return "inventory.movementType.transferDamageReturnOut";
    ...
    case "ProductionMaterialRestoration":
      return "inventory.movementType.productionMaterialVoid";
    case "ProductionOutput":
      return "inventory.movementType.productionOutput";
    case "ProductionOutputReversal":
      return "inventory.movementType.productionOutputVoid";
    default:
