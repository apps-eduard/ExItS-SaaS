...
export const iloPH: Record<keyof typeof en, string> = {
  ...
  "customers.orgNeedsBuyerConnection":
    "Masapul ti Active supplier connection para iti Direct B2B checkout. Bagaen daytoy nga organization nga ag-connect kenka iti Suppliers, ket awaten ti request. Kalpasanna, agparangda iti Customers â†’ Businesses ken iti Sell checkout.",
  ...
  "customers.receivables.loading": "Aglo-load ti receivables…",
...
"customers.statementTitle": "Customer statement",
  ...
  "uiStandards.actionChipsPilotBadge": "ACTION CHIP â€” PILOT / CANDIDATE (Ilokano)",
  "uiStandards.actionChipsPilotLede": "ExItS Action Chip pilot (ExitsChipBar variant=actions + ActionChipBar). Napardas a tignay ken navigation shortcuts â€” saan a Tabs, Filters, Module Subnav, wenno Buttons. Theme ken density manipud Preferences. PILOT / CANDIDATE â€” Docs/UI/exits-action-chip-standard.md.",
  "uiStandards.actionChipsOverviewTitle": "Semantic overview (Ilo)",
  "uiStandards.actionChipsOverviewLede": "Action vs navigation action vs filter vs button â€” agpapada ti label, naisangsangayan ti trabaho.",
  ...
  "uiStandards.actionChipsShapesLede": "Pill, soft, ken square â€” reuse ti locked Chip shape language nga addaan action touch targets.",
  ...
  "uiStandards.cardsPilotLede": "Canonical ExItS Card foundation. Treatments, KPI/entity/product patterns, selectable ken status accents, motion. Theme ken density manipud Preferences. APPROVED / LOCKED â€” Docs/UI/exits-card-standard.md.",
  ...
  "uiStandards.cardsCheatLede": "Locked vocabulary para iti Cursor tasks. APPROVED / LOCKED â€” Docs/UI/exits-card-standard.md.",
