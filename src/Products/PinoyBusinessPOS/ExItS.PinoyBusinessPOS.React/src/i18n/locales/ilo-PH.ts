...
export const iloPH: Record<keyof typeof en, string> = {
  ...
  "uiStandards.actionChipsPilotBadge": "ACTION CHIP — PILOT / CANDIDATE (Ilokano)",
  "uiStandards.actionChipsPilotLede": "ExItS Action Chip pilot (ExitsChipBar variant=actions + ActionChipBar). Napardas a tignay ken navigation shortcuts — saan a Tabs, Filters, Module Subnav, wenno Buttons. Theme ken density manipud Preferences. PILOT / CANDIDATE — Docs/UI/exits-action-chip-standard.md.",
  "uiStandards.actionChipsOverviewTitle": "Semantic overview (Ilo)",
  "uiStandards.actionChipsOverviewLede": "Action vs navigation action vs filter vs button — agpapada ti label, naisangsangayan ti trabaho.",
  ...
  "uiStandards.actionChipsShapesLede": "Pill, soft, ken square — reuse ti locked Chip shape language nga addaan action touch targets.",
  ...
  "uiStandards.cardsPilotLede": "Canonical ExItS Card foundation. Treatments, KPI/entity/product patterns, selectable ken status accents, motion. Theme ken density manipud Preferences. APPROVED / LOCKED — Docs/UI/exits-card-standard.md.",
  ...
  "uiStandards.cardsCheatLede": "Locked vocabulary para iti Cursor tasks. APPROVED / LOCKED — Docs/UI/exits-card-standard.md.",
