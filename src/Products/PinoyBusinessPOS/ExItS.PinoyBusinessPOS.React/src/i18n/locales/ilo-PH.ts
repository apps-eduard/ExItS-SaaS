...
export const iloPH: Record<keyof typeof en, string> = {
  ...
  "uiStandards.cardsPilotBadge": "CARD STANDARD — PILOT / SAAN PAY LOCKED",
  "uiStandards.cardsPilotLede": "Visual pilot para iti ExItS cards. Treatments, KPI/entity/product patterns, selectable ken status accents. Theme ken density manipud Preferences. Dika ipagarup a locked agingga ma-approve.",
