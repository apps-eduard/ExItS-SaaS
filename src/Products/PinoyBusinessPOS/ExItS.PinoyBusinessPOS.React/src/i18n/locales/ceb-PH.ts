...
"offline.todoWillQueue": "Offline ka. Magpabilin kini nga to-do sa device hangtod makakonektar ka.",
  ...
  "purchasing.paidNow": "Kantidad nga gibayad",
  ...
  "purchasing.supplierRequiredForCredit":
    "Pagpili og supplier kung ang gibayad mas gamay kay sa kinatibuk-an.",
  ...
  "supplierPayables.empty": "Walay outstanding supplier credit.",
