...
export const cebPH: Record<keyof typeof en, string> = {
  ...
  "uiStandards.actionChipsPilotBadge": "ACTION CHIP — PILOT / CANDIDATE (Cebuano)",
  "uiStandards.actionChipsPilotLede": "ExItS Action Chip pilot (ExitsChipBar variant=actions + ActionChipBar). Light actions ug navigation shortcuts — dili Tabs, Filters, Module Subnav, o Buttons. Theme ug density gikan sa Preferences. PILOT / CANDIDATE — Docs/UI/exits-action-chip-standard.md.",
  "uiStandards.actionChipsOverviewTitle": "Semantic overview (Ceb)",
  "uiStandards.actionChipsOverviewLede": "Action vs navigation action vs filter vs button — parehas og label, lain og trabaho.",
  ...
  "uiStandards.actionChipsShapesLede": "Pill, soft, ug square — reuse sa locked Chip shape language nga may action touch targets.",
  ...
  "uiStandards.cardsPilotLede": "Canonical ExItS Card foundation. Treatments, KPI/entity/product patterns, selectable ug status accents, motion. Theme ug density gikan sa Preferences. APPROVED / LOCKED — Docs/UI/exits-card-standard.md.",
