...
export const cebPH: Record<keyof typeof en, string> = {
  ...
  "connectivity.reconnecting": "Nagkonekta pag-usabÖ",
  ...
  "loading.preparingWorkspace": "[CEB] Preparing your workspaceÖ",
  "loading.switchingWorkspace": "[CEB] Switching workspaceÖ",
  "loading.updating": "[CEB] UpdatingÖ",
  "loading.working": "[CEB] WorkingÖ",
...
"offline.todoWillQueue": "Offline ka. Magpabilin kini nga to-do sa device hangtod makakonektar ka.",
  ...
  "personal.ownershipTransfers.staleConflict":
    "Nausab ang transfer. Na-refresh ang lista ó tan-awa pag-usab.",
