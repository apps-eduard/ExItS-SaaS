...
export const cebPH: Record<keyof typeof en, string> = {
  ...
  "catalog.businessUsage.resale": "Ibaligya nga wala?y usab",
  "catalog.businessUsage.resaleHint": "Mahimong paliton sa kostumer kini nga produkto mismo.",
  ...
  "catalog.businessUsage.filterResale": "Ibaligya nga wala?y usab",
  ...
  "stockCount.orgScopeNote": "Ang stock count nag-reconcile sa organization-level on-hand (dili usa ka branch shelf).",
  ...
  "stockCount.offline": "Kinahanglan og online connection ang stock count.",
...
"offline.todoWillQueue": "Offline ka. Magpabilin kini nga to-do sa device hangtod makakonektar ka.",
  ...
  "staffManage.ownerProtectedNote": "Kini ang tag-iya sa negosyo.",
