...
export const cebPH: Record<keyof typeof en, string> = {
  ...
  "connectivity.reconnecting": "Nagkonekta pag-usabù",
  ...
  "checkout.confirmingTransaction": "Gina-confirm ang transaksyonù",
  ...
  "devices.registerHint": "Signing in does not use a device slot. Explicit registration does ù and it stays on this browser across tabs and reloads.",
  ...
  "loading.preparingWorkspace": "[CEB] Preparing your workspaceù",
  "loading.switchingWorkspace": "[CEB] Switching workspaceù",
  "loading.updating": "[CEB] Updatingù",
  "loading.working": "[CEB] Workingù",
...
"offline.todoWillQueue": "Offline ka. Magpabilin kini nga to-do sa device hangtod makakonektar ka.",
  ...
  "store.landing.lede": "Padayon sa ExItS aron maka-order gikan niining negosyo.",
  ...
  "store.install.detail": "Idugang ang ExItS sa home screen para mas paspas. Opsiyonal ù mahimo kang magpadayon sa browser.",
  ...
  "org.ownershipTransfer.staleConflict":
    "Nausab ang transfer. Na-refresh ang page ù susiha pag-usab.",
  ...
  "people.summary": "[CEB] {identified} with ExItS ID ù {local} local only",
  ...
  "personal.guide.feature.install-pwa.bullet1": "Opsyonal ang install ù mahimo kang magpadayon sa browser.",
  ...
  "personal.guide.feature.todo-reminders.bullet3": "Pahinumdom ra kini ù dili ni maglihok og kwarta.",
  ...
  "personal.home.attentionDueSoonOne": "{name} ù due soon",
  "personal.home.attentionOverdue": "{count} payments overdue",
  "personal.home.attentionOverdueOne": "{name} ù payment overdue",
  ...
  "personal.home.storesLoading": "Loading store balancesù",
  ...
  "personal.ownershipTransfers.staleConflict":
    "Nausab ang transfer. Na-refresh ang lista ù tan-awa pag-usab.",
  ...
  "personal.utang.accountsLoading": "Loading accountsù",
  ...
  "personal.utang.whatHappenedBorrowed": "What happened? I borrowed money ù I owe someone.",
  "personal.utang.whatHappenedLent": "What happened? I lent money ù someone owes me.",
  ...
  "personal.utang.workspaceMeta": "{active} active ù {people} people",
  ...
  "shift.pwaRegisterPreparing": "Creating PWA-0001ù",
