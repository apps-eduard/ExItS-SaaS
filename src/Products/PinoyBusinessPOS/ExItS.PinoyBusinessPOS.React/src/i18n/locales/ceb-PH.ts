...
export const cebPH: Record<keyof typeof en, string> = {
  ...
  "uiStandards.cardsPilotBadge": "CARD STANDARD — PILOT / DILI PA LOCKED",
  "uiStandards.cardsPilotLede": "Visual pilot para sa ExItS cards. Treatments, KPI/entity/product patterns, selectable ug status accents. Theme ug density gikan sa Preferences. Ayaw isipon nga locked hangtod ma-approve.",
  ...
  "uiStandards.cardsCheatLede": "Candidate vocabulary para sa Cursor tasks. PILOT — dili pa locked.",
