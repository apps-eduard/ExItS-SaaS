...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "uiStandards.tableDemoLede": "Approved ExitsTable reference with search, filter, sort, multi-select, output icons, pagination, and Actions column pilot.",
  ...
  "uiStandards.tableCheatLede": "Use these terms in Cursor tasks. Explicit ON/OFF overrides FULL TABLE defaults. Extension vocabulary is PILOT until re-lock.",
  "uiStandards.tablesExtensionPilotBadge": "TABLE EXTENSION — PILOT / NOT YET MERGED INTO LOCKED STANDARD",
