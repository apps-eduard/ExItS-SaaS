...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "uiStandards.cardsPilotBadge": "CARD STANDARD — PILOT / NOT LOCKED",
  "uiStandards.cardsPilotLede": "Visual pilot para sa ExItS cards. Treatments, KPI/entity/product patterns, selectable at status accents. Theme at density mula sa Preferences. Huwag ituring na locked hanggang ma-approve.",
  ...
  "uiStandards.cardsCheatLede": "Candidate vocabulary para sa Cursor tasks. PILOT — hindi pa locked.",
