...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "branches.deliveryAreas.regionSearchPlaceholder": "Maghanap ng rehiyonÃ¢â‚¬Â¦",

  "branches.deliveryAreas.regionSelected": "Napiling rehiyon",

  "branches.deliveryAreas.changeRegion": "Palitan",

  "branches.deliveryAreas.noRegionMatch": "Walang tumutugmang rehiyon",

  "branches.deliveryAreas.regionsLoading": "Nilo-load ang mga rehiyonÃ¢â‚¬Â¦",

  "branches.deliveryAreas.regionsFailed": "Hindi ma-load ang mga rehiyon.",

  "branches.deliveryAreas.pickRegionFirst": "Pumili muna ng rehiyon para pumili ng mga lungsod.",

  "branches.deliveryAreas.citiesInRegion": "Mga lungsod at munisipyo",

  "branches.deliveryAreas.citySelect": "Lungsod / munisipyo",

  "branches.deliveryAreas.cityPlaceholder": "Pumili ng lungsod o munisipyo",

  "branches.deliveryAreas.citiesLoading": "Nilo-load ang mga lungsodÃ¢â‚¬Â¦",

  "branches.deliveryAreas.citiesFailed": "Hindi ma-load ang mga lungsod.",

  "branches.deliveryAreas.noCitiesInRegion": "Walang lungsod sa rehiyong ito.",
  ...
  "branches.deliveryAreasLede": "Pumili muna ng rehiyon, pagkatapos ay piliin ang mga lungsod o munisipyo kung saan magde-deliver ang branch na ito.",
  ...
  "branches.deliveryAreas.replaceHint": "Pumili ng rehiyon, pagkatapos ay pumili ng opisyal na lungsod o munisipyo para palitan ang hindi pa na-verify na area.",
  ...
  "branches.type": "Uri ng branch",

  "branches.type.retail": "Retail (benta)",

  "branches.type.warehouse": "Bodega",

  "branches.type.retailHelp": "Lokasyon para sa pagbebenta at imbentaryo.",

  "branches.type.warehouseHelp": "Imbentaryo, pagbili, at transfer lang ? walang retail sales.",
  ...
  "branches.setup.title": "Setup ng branch",

  "branches.setup.description": "Suriin ang bawat bahagi bago maging live ang branch na ito.",

  "branches.setup.backToBranch": "Bumalik sa branch",

  "branches.setup.overall": "Kabuuang kahandaan",

  "branches.setup.overallStatus.NotStarted": "Hindi pa nagsisimula",

  "branches.setup.overallStatus.NeedsAttention": "Kailangan ng pansin",

  "branches.setup.overallStatus.Ready": "Handa na",

  "branches.setup.section.Details": "Detalye ng branch",

  "branches.setup.section.Staff": "Access ng staff",

  "branches.setup.section.Products": "Mga produkto",

  "branches.setup.section.Pricing": "Presyo",

  "branches.setup.section.Inventory": "Simulang inventory",

  "branches.setup.section.Parties": "Mga customer at supplier",

  "branches.setup.section.Fulfillment": "Fulfillment",

  "branches.setup.section.Device": "Mga device",

  "branches.setup.sectionStatus.Complete": "Kumpleto",

  "branches.setup.sectionStatus.NeedsAttention": "Kailangan ng pansin",

  "branches.setup.sectionStatus.Optional": "Opsyonal",

  "branches.setup.sectionStatus.NotApplicable": "Hindi applicable",

  "branches.setup.openSection": "Buksan",

  "branches.setup.markVisited": "Markahan bilang nabisita",

  "branches.setup.loadError": "Hindi ma-load ang kahandaan ng branch setup.",

  "branches.setup.workspaceBranchHint": "Palitan ang workspace branch para tumugma sa setup page na ito para sa operational actions.",
  ...
  "cashHandling.remove": "Alisin ang {amount} denomination",
  ...
  "catalog.businessUsage.resaleHint": "Binibili at ibinebenta ang parehong product sa customer.",
  ...
  "catalog.businessUsage.filterResale": "Para ibenta",
  ...
  "checkout.creditPolicy.loading": "Nilo-load ang credit policyÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦",
  ...
  "checkout.utangCustomerIdleEmpty":
    "No checkout customers yet. People and businesses share this directory ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Utang requires an Approved person with available credit.",
  "checkout.directoryCredit.approvedAvailable": "Approved ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Available {amount}",
  ...
  "checkout.directoryCredit.availableEmDash": "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â",
  ...
  "connected.discountPercentHelp": "Same % off each selected productÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s Default PO (B2B discount). Fixed buyer price is only available for one product.",
  ...
  "connected.increasePercentHelp": "Same % up each selected productÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s Default PO (B2B markup). Fixed buyer price is only available for one product.",
  ...
  "connected.trackProductFailed": "Hindi ma-enable ang inventory tracking.",
  "connected.untrackProductFailed": "Hindi ma-disable ang inventory tracking.",
  ...
  "customers.creditPolicy.limitHelper":
    "Maximum na hindi pa bayad na credit na maaaring mayroon ang customer nang sabay-sabay.",
  ...
  "customers.creditPolicy.reasonForChange": "Dahilan ng pagbabago",

  "customers.creditPolicy.reasonForChangeHelper":
    "Required. Nire-record sa credit audit history.",
  ...
  "customers.creditPolicy.setCreditTerms": "Itakda ang credit terms",

  "customers.creditPolicy.setNewCreditTerms": "Magtakda ng bagong credit terms",
  ...
  "customers.creditPolicy.utangAllowed": "Pinapayagan ang Utang",

  "customers.creditPolicy.utangAllowedYes": "Oo",
  "customers.creditPolicy.utangAllowedNo": "Hindi",

  "customers.creditPolicy.customTerm": "Custom na term",
  ...
  "customers.creditPolicy.termDaysUnit": "araw",
  ...
  "customers.branchAccess.help":
    "Customer stays organization-owned. Areas only help select branches ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â access is saved as an explicit branch list.",
  ...
  "customers.branchAccess.saving": "SavingÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦",
  ...
  "customers.orgNeedsBuyerConnection":
    "Kailangan ng Active supplier connection para sa Direct B2B checkout. Sabihin sa organization na ito na mag-connect sa iyo sa Suppliers, tapos tanggapin ang request. Pagkatapos, lalabas sila sa Customers ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Businesses at sa Sell checkout.",
  ...
  "customers.receivables.pageTitle": "Mga bukas na receivable",
  "customers.receivables.openTitle": "Mga bukas na receivable",
  "customers.receivables.openCount": "{count} bukas",
  "customers.receivables.allocateManually": "I-allocate nang manual",
  "customers.receivables.allocateAutomatically": "I-allocate nang awtomatiko",
  "customers.receivables.allocationPreview": "Preview ng allocation",
  "customers.receivables.allocationAuto": "Awtomatiko (pinakamatandang due muna)",
  "customers.receivables.allocationManual": "Manual na allocation",
  "customers.receivables.allocationPreviewReady": "Tugma ang manual allocation sa bayad.",
  "customers.receivables.allocationSumMismatch": "Dapat tumugma ang kabuuang allocation sa bayad.",
  "customers.receivables.allocationExceeds": "Hindi pwedeng mag-allocate nang higit sa outstanding ng receivable.",
  "customers.receivables.allocationInvalidLine": "Maglagay ng positibong halaga para sa bawat napiling receivable.",
  ...
  "customers.receivables.source.other": "Iba pa",
  ...
  "customers.receivables.loading": "Naglo-load ng receivablesÃ¢â‚¬Â¦",
  ...
  "uiStandards.cancelIconPilotNote": "Locked Cancel icons: CircleX ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Cancel / dismiss. CornerUpLeft ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Cancel and return / abandon edit. X ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Close-only (also shown as minimal Cancel candidate for comparison). ArrowLeft ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Back/navigation.",
  ...
  "uiStandards.buttonPilotBadge": "BUTTON STANDARD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â APPROVED / LOCKED",
  ...
  "uiStandards.tabsPilotBadge": "TABS STANDARD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â APPROVED / LOCKED",
  "uiStandards.tabsPilotLede": "Canonical ExItS Tabs (ExitsTabs). Seven variants, CountBadge counts, keyboard/ARIA, theme and density from Preferences. APPROVED / LOCKED ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Docs/UI/exits-tabs-standard.md.",
  ...
  "uiStandards.moduleSubnavPilotBadge": "MODULE SUBNAV ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â PILOT / CANDIDATE",
  "uiStandards.moduleSubnavPilotLede": "Canonical ExItS Module Subnav (route destinations inside one module ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â not Tabs). Variants, icons, counts, Pill Bar treatments. Theme and density from Preferences. PILOT / CANDIDATE ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Docs/UI/exits-module-subnav-standard.md.",
  ...
  "uiStandards.actionChipsPilotBadge": "ACTION CHIP ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â PILOT / CANDIDATE",
  "uiStandards.actionChipsPilotLede": "Canonical ExItS Action Chip pilot (ExitsChipBar variant=actions baseline + ActionChipBar gallery). Quick actions and navigation shortcuts ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â not Tabs, Filters, Module Subnav, or Buttons. Theme and density from Preferences. PILOT / CANDIDATE ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Docs/UI/exits-action-chip-standard.md.",
  "uiStandards.actionChipsOverviewTitle": "Semantic overview",
  "uiStandards.actionChipsOverviewLede": "Action vs navigation action vs filter vs button ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â same-looking labels, different jobs.",
  ...
  "uiStandards.actionChipsShapesLede": "Pill, soft, and square ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â reuse locked Chip shape language with action touch targets.",
  ...
  "uiStandards.actionChipsGroupsLede": "Inline, wrap, scroll, responsive auto, grid, primary-first, sectioned, overflow, and mixed button compositions. Every pattern includes mobile.",
  "uiStandards.actionChipsRealWorldTitle": "Real-world examples",
  ...
  "uiStandards.cardsPilotBadge": "CARD STANDARD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â APPROVED / LOCKED",
  "uiStandards.cardsPilotLede": "Canonical ExItS Card foundation. Treatments, KPI/entity/product patterns, selectable at status accents, motion. Theme at density mula sa Preferences. APPROVED / LOCKED ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Docs/UI/exits-card-standard.md.",
  ...
  "uiStandards.cardsCheatLede": "Locked vocabulary para sa Cursor tasks. APPROVED / LOCKED ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Docs/UI/exits-card-standard.md.",
  "uiStandards.chipPilotBadge": "CHIP STANDARD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â APPROVED / LOCKED",
  ...
  "uiStandards.tablesExtensionPilotBadge": "TABLE STANDARD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â APPROVED / LOCKED",
  ...
  "exitsTable.range": "{from}ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“{to} of {total}",
  ...
  "inventory.expiryCounts": "Expired lots: {expired} Ãƒâ€šÃ‚Â· Near expiry lots: {near}",
  ...
  "inventory.accessibleInventory": "Naa-access na imbentaryo",

  "inventory.accessibleOnHand": "Naa-access na nasa kamay: {qty} {uom}",

  "inventory.accessibleReserved": "Nakareserba: {qty}",

  "inventory.accessibleAvailable": "Magagamit: {qty}",

  "inventory.accessibleScopeNote": "Sakop lang nito ang mga sangay na maa-access mo, hindi ang buong organisasyon.",
  ...
  "inventory.branchNameUnknown": "Hindi kilalang branch",

  "inventory.thisBranch": "branch na ito",
  ...
  "inventory.expirationTrackingOnWithWarning": "Expiration tracking ON Ãƒâ€šÃ‚Â· {days}-day warning",
  ...
  "transfer.exceptionInspectInvalidQty": "Enter valid inspection quantities.",
  ...
  "stockCount.countPeriod": "Panahon ng bilang",

  "stockCount.period.weekly": "Lingguhan",

  "stockCount.period.monthly": "Buwanan",

  "stockCount.period.quarterly": "Quarterly",

  "stockCount.period.annual": "Taunan",

  "stockCount.period.custom": "Pasadya",

  "stockCount.fieldTitle": "Pangalan ng bilang",

  "stockCount.titleSuggestedHint": "Iminungkahing pangalan ? puwede mong i-edit.",
  ...
  "production.setups.noProductionIngredientsYet": "Wala pang production ingredients.",
  "production.setups.noProductionIngredientsDetail": "Markahan muna ang produkto bilang \"Can be used as production ingredient\" sa Products. Kailangan ang inventory tracking para sa ingredients.",
  ...
  "incomingOrders.accept": "Tanggapin ang order",

  "incomingOrders.actionFailed": "Hindi ma-update ang order na ito.",

  "incomingOrders.backList": "Bumalik sa incoming orders",
  ...
  "incomingOrders.decline": "Tanggihan",

  "incomingOrders.declineNote": "Tala (opsyonal)",

  "incomingOrders.declineReason": "Dahilan ng pagtanggi",

  "incomingOrders.declineReason.cannotFulfillQuantity": "Hindi makumpleto ang dami",

  "incomingOrders.declineReason.other": "Iba pa",

  "incomingOrders.declineReason.outOfStock": "Walang stock",

  "incomingOrders.declineReason.priceOrOrderIssue": "Problema sa presyo o order",

  "incomingOrders.declineReason.unableToFulfill": "Hindi matupad",
  ...
  "incomingOrders.emptyHelp": "Ang mga purchase order mula sa connected buyers ay lilitaw dito.",

  "incomingOrders.filterAccepted": "Tinanggap",

  "incomingOrders.filterAll": "Lahat",

  "incomingOrders.filterCompleted": "Tapos na",

  "incomingOrders.filterDeclined": "Tinanggihan",

  "incomingOrders.filterPending": "Nakabinbin",

  "incomingOrders.filterPreparing": "Inihahanda",

  "incomingOrders.lede": "Mga purchase order mula sa connected buyers. Hiwalay sa connection requests.",
  ...
  "incomingOrders.statusCompletedRemainingCancelled": "Tapos Â· Kinansela ang natitirang dami",
  "incomingOrders.statusReceivedAwaitingPayment": "Natanggap · Hinihintay ang bayad",
  "incomingOrders.awaitingPaymentTitle": "Hinihintay ang bayad",
  "incomingOrders.awaitingPaymentSellerBody":
    "Kinumpirma na ng buyer ang pagtanggap. Kumpirmahin ang bayad na nakolekta para matapos ang order.",
  "incomingOrders.awaitingPaymentBuyerBody":
    "Natanggap na ang mga item. Kailangan pang kumpirmahin ng supplier ang bayad bago matapos ang order.",
  "incomingOrders.remainingDue": "Natitirang babayaran",
  "incomingOrders.confirmPayment": "Kumpirmahin ang bayad",
  "incomingOrders.confirmPaymentTitle": "Kumpirmahin ang natanggap na bayad",
  "incomingOrders.confirmPaymentBody":
    "Itala ang aktwal na nakolektang halaga. Kung bahagya lang, mananatiling hinihintay ang bayad.",
  "incomingOrders.settlementAmount": "Halagang natanggap",
  "incomingOrders.settlementMethod": "Paraan ng bayad",
  "incomingOrders.settlementReference": "Reference",
  "incomingOrders.settlementCheckCleared": "Cleared na ang tseke",
  "incomingOrders.sellerRemarks": "Paalala ng supplier",
  "incomingOrders.buyerReceiptRemarks": "Paalala ng buyer sa pagtanggap",
  "incomingOrders.settlementConfirmed": "Kumpirmado ang bayad",
  ...
  "incomingOrders.noMatchHelp": "Subukan ang ibang pangalan ng buyer o PO number.",

  "incomingOrders.notFound": "Hindi nahanap ang incoming order.",

  "incomingOrders.orderDate": "Petsa ng order",
  "incomingOrders.orderInfoTitle": "Impormasyon ng order",
  "incomingOrders.orderTotal": "Order total",

  "incomingOrders.review": "Suriin ang order",

  "incomingOrders.search": "Maghanap ayon sa buyer o PO number",

  "incomingOrders.startPreparing": "Simulang ihanda",
  ...
  "incomingOrders.statusDeclined": "Tinanggihan",
  ...
  "incomingOrders.summary": "{products} produkto ? {units} unit",

  "incomingOrders.title": "Incoming orders",

  "incomingOrders.total": "Kabuuan",

  "incomingOrders.unnamedPo": "Purchase order",

  "incomingOrders.viewOnly": "Makikita mo ang order, pero purchasing managers lang ang puwedeng tumugon.",
  ...
  "inventory.movementType.transferExceptionHold": "Exception transfer received",
  "inventory.movementType.transferExceptionExpectedRestore": "Exception expected restore",
  "inventory.movementType.transferExceptionActualOut": "Exception actual out",
  "inventory.movementType.transferExceptionReturnOut": "Exception returned to source",
  "inventory.movementType.transferExceptionReturnIn": "Exception return received",
  ...
  "orders.branchUnavailableTitle": "Hindi available ang branch",

  "orders.branchUnavailableDetail": "Ang storefront link na ito ay tumuturo sa branch na hindi available para sa pag-order.",
  ...
  "operations.nav.aria": "Navigation ng operasyon",
  ...
  "operations.shell.operations": "Operasyon",
  ...
  "store.landing.branchLede": "Binubuksan mo ang isang tiyak na branch storefront sa ExItS.",
  ...
  "store.landing.invalidBranch": "Hindi wasto ang link ng branch storefront.",
  ...
  "org.more.stockMovements": "Mga galaw ng stock",

  "warehouse.title": "Bodega",

  "warehouse.lede": "Operasyon para sa {branch}",

  "warehouse.ledeFallback": "Operasyon ng bodega",

  "warehouse.quickActions": "Mabilis na aksyon",

  "warehouse.action.receiveStock": "Tanggapin ang stock",

  "warehouse.action.transferStock": "Ilipat ang stock",
  ...
  "warehouse.incoming": "Papasok",

  "warehouse.incomingEmpty": "Walang naghihintay",

  "warehouse.incomingEmptyDetail": "Lalabas dito ang papasok na transfer at purchase order na kailangan ng aksyon.",

  "warehouse.fromBranch": "Pinagmulang branch",

  "warehouse.stockAlerts": "Mga alerto sa stock",

  "warehouse.lowStock": "Kulang ang stock",

  "warehouse.expiredLots": "Mga lot na expired",

  "warehouse.nearExpiryLots": "Malapit nang ma-expire",

  "warehouse.pendingTransfers": "{count} pending na transfer",

  "warehouse.loading": "Nilo-load ang bodega...",

  "warehouse.loadError": "Hindi ma-load ang overview ng bodega.",

  "expense.title": "Mga Gastos",

  "expense.orgScopeNote": "Mga gastos ng negosyo para sa organisasyong ito.",

  "expense.scope.label": "Saklaw",

  "expense.scope.allBranches": "Lahat ng assigned na branch",

  "expense.scope.organization": "Mga gastos ng organisasyon",

  "expense.scope.allExpenses": "Lahat ng gastos",

  "expense.scope.createLabel": "Itala laban sa",
  ...
  "expense.validation.scopeRequired": "Pumili kung saan itatala ang gastos.",
...
"orgProfile.title": "Organization profile",
  ...
  "orgSubscription.loading": "Ikinakarga ang subscription moÃ¢â‚¬Â¦",
  ...
  "orgSubscription.comparing": "Tinitingnan ang epektoÃ¢â‚¬Â¦",
  ...
  "personal.explore.billingBestValueSave": "Best value ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Save {percent}%",
  "personal.explore.billingSavePercent": "Save {percent}%",
  "personal.explore.cycleSavings": "Save {percent}%",
  "personal.explore.cycleSavingsDetail": "Save {amount} Ãƒâ€šÃ‚Â· {percent}%",
  ...
  "personal.explore.capacityLine": "{branches} branch Ãƒâ€šÃ‚Â· {staff} staff Ãƒâ€šÃ‚Â· {devices} POS",
  ...
  "paymentMethods.loading": "Loading payment methodsÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦",
  ...
  "subscriptionCheckout.processing": "ProcessingÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦",
  ...
  "subscriptionCheckout.card.scenarioSuccess": "4242ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ success",
  "subscriptionCheckout.card.scenarioDecline": "4000ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦0002 fail",
  "subscriptionCheckout.card.scenarioProcessing": "4000ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦9995 processing",
  "subscriptionCheckout.card.ruleSuccess": "4242 4242 4242 4242 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Paid",
  "subscriptionCheckout.card.ruleDecline": "4000 0000 0000 0002 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Failed",
  "subscriptionCheckout.card.ruleProcessing": "4000 0000 0000 9995 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Processing",
  ...
  "personal.workplaces.lede":
    ...
    "Mga negosyo kung saan ka staff. Mananatiling hiwalay ang Personal account sa work login ng bawat workplace.",

  "personal.workplaces.moreTile": "Mga workplace",

  "personal.workplaces.pendingSection": "Mga pending invitation",

  "personal.workplaces.mineSection": "Mga workplace ko",

  "personal.workplaces.pendingEmpty": "Walang pending na staff invitation.",

  "personal.workplaces.openInvitations": "Buksan ang staff invitations",

  "personal.workplaces.emptyTitle": "Wala ka pang workplace.",

  "personal.workplaces.emptyDetail":

    "Kapag tumanggap ka ng staff invitation, mananatili rito ang workplace kasama ang work login mo.",

  "personal.workplaces.loadError": "Hindi ma-load ang mga workplace.",

  "personal.workplaces.statusActive": "Active na staff",
  ...
  "personal.workplaces.roleUnknown": "Hindi pa na-assign",

  "personal.workplaces.branchUnknown": "Hindi pa na-assign",

  "personal.workplaces.branchPending": "I-a-assign pagkatapos ng sync",

  "personal.workplaces.workLogin": "Work login",

  "personal.workplaces.personalAccount": "Personal account",

  "personal.workplaces.open": "Buksan ang workplace",

  "personal.workplaces.openNamed": "Buksan ang {org}",

  "personal.workplaces.copyLogin": "Kopyahin ang login",

  "personal.workplaces.copied": "Nakopya",

  "personal.workplaces.copyFailed": "Hindi makopya ang work login.",

  "personal.workplaces.acceptedTitle": "Nasa team ka na",
  ...
  "purchasing.addStockToBranch": "Idagdag ang stock sa {name}",

  "purchasing.orderProducts": "Mga produktong ioorder",

  "purchasing.connectedOrderingHelp": "Mga naka-link na shared product lang ang maaaring i-order dito.",

  "purchasing.noReadyProducts": "Walang produktong handa pang i-order.",

  "purchasing.noReadyProductsHelp": "I-link muna ang shared catalog products, tapos bumalik dito para mag-order.",

  "purchasing.openSharedCatalog": "Buksan ang shared catalog",

  "purchasing.supplierSku": "SKU ng supplier",
  ...
  "purchasing.addProduct": "Idagdag",

  "purchasing.categoryAll": "Lahat",

  "purchasing.categoryOther": "Iba pa",

  "purchasing.categoryFilter": "Mga kategorya ng produkto",

  "purchasing.setupTabHelp": "I-link o ayusin muna ang mga produktong ito sa Shared catalog bago mag-order.",

  "purchasing.connectInSharedCatalog": "I-connect sa shared catalog",

  "purchasing.noSetupProducts": "Walang produkto sa setup status na ito.",

  "purchasing.noSetupProductsHelp": "Lumipat sa Linked para mag-order, o buksan ang Shared catalog.",

  "purchasing.increaseQty": "Dagdagan ang dami",

  "purchasing.decreaseQty": "Bawasan ang dami",

  "purchasing.draftSummary": "{products} produkto ? {units} unit",

  "purchasing.subtotal": "Kabuuan",
  ...
  "purchasing.editTitle": "I-edit ang purchase order",
  "purchasing.editOrder": "I-edit ang order",
  "purchasing.saveOrder": "I-save ang order",
  ...
  "purchasing.allOther": "Iba pa",
  "purchasing.classifyAs": "Uriin bilang",
  "purchasing.otherDiscrepancy": "Iba pa",
  "purchasing.otherReason": "Dahilan",
  "purchasing.otherReasonDescription": "Maikling paglalarawan",
  "purchasing.otherReasonWrongItem": "Maling item",
  "purchasing.otherReasonWrongVariant": "Maling variant",
  "purchasing.otherReasonExpired": "Expired",
  "purchasing.otherReasonPackagingIssue": "Problema sa packaging",
  "purchasing.otherReasonQualityIssue": "Problema sa kalidad",
  "purchasing.otherReasonOther": "Iba pa (ilarawan)",
  ...
  "purchasing.activity.awaitingPayment": "Hinihintay ang bayad",
  "purchasing.activity.paymentConfirmed": "Kumpirmado ang bayad",
  "purchasing.activity.noPaymentDue": "Walang babayaran",
  ...
  "purchasing.inventoryNotCurrentlyTracked": "Hindi kasalukuyang naka-track ang inventory.",

  "purchasing.inventoryTrackingEnabled": "Na-enable ang inventory tracking",

  "purchasing.enableInventoryTracking": "I-enable ang inventory tracking",
...
"purchasing.readyForPurchaseOrders": "Ready for purchase orders",
  ...
  "purchasing.purchaseAmount": "Halaga ng bili",

  "purchasing.purchasePrice": "Presyo ng bili",
  ...
  "purchasing.previousTrackedStock": "Dati",

  "purchasing.newTrackedStock": "Bagong tracked stock",

  "purchasing.receiptCompleted": "Tapos na ang receipt",
  ...
  "purchasing.receivingWill": "Ang pagtanggap ay:",

  "purchasing.trackingStartsWithReceived":

    "Magsisimula ang tracking sa quantity na natanggap sa receipt na ito.",
...
"purchasing.paymentAtReceipt": "Bayad sa resibo",
  ...
  "managerHome.lede": "Ano ang nangyayari sa branch ngayon, at ano ang kailangan ng pansin.",

  "managerHome.loading": "Nilo-load ang operasyon ng branch...",

  "managerHome.loadError": "Hindi ma-load ang manager home.",

  "managerHome.warehouseTitle": "Operasyon ng warehouse",

  "managerHome.warehouseLede": "Receiving, transfer, at inventory na kailangan ng pansin.",

  "managerHome.section.today": "Today",

  "managerHome.section.needsAttention": "Kailangan ng pansin",

  "managerHome.section.quickActions": "Mabilis na aksyon",

  "managerHome.section.snapshot": "Buod ng operasyon",

  "managerHome.section.stockSnapshot": "Buod ng stock",

  "managerHome.section.insights": "Insights",

  "managerHome.today.sales": "Benta ngayon",

  "managerHome.today.transactions": "Transaksyon",

  "managerHome.today.shift": "Shift",

  "managerHome.today.register": "Register",

  "managerHome.today.noSales": "Wala pang benta ngayon",

  "managerHome.shift.open": "Open",

  "managerHome.shift.closed": "Walang bukas na shift",

  "managerHome.shift.view": "Tingnan ang shift",

  "managerHome.shift.openAction": "Buksan ang shift",

  "managerHome.register.none": "-",

  "managerHome.attention.healthy": "Mukhang kontrolado ang lahat",

  "managerHome.attention.healthyDetail": "Walang low-stock, expiry, order, o shift na kailangan ng aksyon.",

  "managerHome.attention.generic": "Kailangan ng pansin",

  "managerHome.attention.lowStock": "Kulang ang stock",

  "managerHome.attention.lowStockDetail": "{count} produktong kulang",

  "managerHome.attention.expiry": "Malapit nang mag-expire",

  "managerHome.attention.expiryDetail": "{count} lot na malapit mag-expire o expired na",

  "managerHome.attention.orders": "Customer order",

  "managerHome.attention.ordersDetail": "{count} na naghihintay ng aksyon",

  "managerHome.attention.purchasing": "Purchase order",

  "managerHome.attention.purchasingDetail": "{count} na tatanggapin",

  "managerHome.attention.transfers": "Transfers",

  "managerHome.attention.transfersDetail": "{count} na pending",

  "managerHome.attention.utang": "Overdue na Utang",

  "managerHome.attention.utangDetail": "{amount} na overdue",

  "managerHome.attention.shift": "Walang bukas na shift",

  "managerHome.attention.shiftDetail": "Magbukas muna ng shift bago magbenta.",

  "managerHome.action.createPo": "Gumawa ng purchase order",

  "managerHome.action.recordExpense": "Itala ang gastos",
  ...
  "managerHome.snapshot.ordersDetail": "{count} bukas na customer order",

  "managerHome.snapshot.ordersClear": "Walang bukas na customer order",

  "managerHome.snapshot.purchasing": "Purchasing",

  "managerHome.snapshot.purchasingDetail": "{count} handang tanggapin",

  "managerHome.snapshot.purchasingClear": "Walang PO na tatanggapin",
  ...
  "managerHome.snapshot.transfersDetail": "{count} papasok",

  "managerHome.snapshot.transfersClear": "Walang papasok na transfer",

  "managerHome.warehouse.incomingTransfers": "Papasok na transfer",

  "managerHome.warehouse.receivablePos": "Handang tanggapin",
  ...
  "sell.floatingCartViewLabel": "Tingnan",
  ...
  "sell.linePreview": "{qty} {unit} ÃƒÆ’Ã¢â‚¬â€ {price} = {amount}",
  ...
  "shell.needsAttention.missingFulfillmentReason":
    "Enable Delivery or Pickup so this branch can fulfill connected purchase orders",
  ...
  "staffManage.ownerProtectedNote": "Protektadong owner account",
  ...
  "summary.itemQty": "Dami",
  "summary.itemUnitPrice": "Presyo bawat unit",
  "summary.itemLineTotal": "Kabuuan ng linya",
  ...
  "summary.subtitle": "Talaan ng sale at mga aksyon",

  "summary.subtotal": "Subtotal",

  "summary.title": "Detalye ng Transaksyon",
  ...
  "staffManage.protectedAccount": "Protektadong owner account",

  "staffManage.status.removed": "Tinanggal",

  "staffManage.status.suspended": "Nasuspinde",

  "staffManage.status.active": "Aktibo",
  ...
  "staffAssign.manageLede": "I-update ang POS role at location access ng member na ito.",

  "staffAssign.manageConfirmAction": "I-save ang mga pagbabago",
  ...
  "staffAssign.allBranches": "Lahat ng active locations",

  "staffAssign.allBranchesHint": "Access sa lahat ng current at future active locations sa organisasyong ito.",

  "staffAssign.areaScope": "Area(s)",

  "staffAssign.areaScopeHint":

    "Access sa lahat ng locations sa mga napiling Area.",

  "staffAssign.areaRequired": "Pumili ng kahit isang area.",
  ...
  "areas.detail.transfer": "Ilipat",

  "areas.detail.assignConfirmTitle": "I-assign ang location na ito?",

  "areas.detail.assignConfirmDetail": "I-assign si {location} sa {area}.",

  "areas.detail.assignConfirmAction": "I-assign",

  "areas.detail.transferConfirmTitle": "Ilipat ang location na ito?",

  "areas.detail.transferConfirmDetail": "Ilipat si {location} mula {fromArea} papunta sa {area}.",

  "areas.detail.transferConfirmAction": "Ilipat",

  "areas.detail.removeConfirmTitle": "Alisin ang location na ito?",

  "areas.detail.removeConfirmDetail": "Alisin si {location} mula sa {area}. Mananatiling active at unassigned ang location.",

  "areas.detail.removeConfirmAction": "Alisin",

  "staffAssign.areasSummary": "Mga area",

  "staffAssign.specificBranches": "Tiyak na locations",

  "staffAssign.specificBranchesHint": "Pumili ng indibidwal na Retail at Warehouse locations.",

  "staffAssign.singleBranchAutomatic": "Automatic: {branch}",

  "staffAssign.mainBranch": "Main",

  "staffAssign.branchAutomaticAll":

    "May access na ang Organization Owner at Administrator sa lahat ng active locations.",

  "staffAssign.branchNoneActive": "Walang available na active locations para i-assign.",

  "staffAssign.branchRequired": "Pumili ng kahit isang location.",

  "staffAssign.branchSaveError": "Na-save ang POS role, pero hindi na-update ang location access.",

  "staffManage.branchAccess": "Location access",

  "staffManage.branchAccessAll": "Lahat ng active locations",

  "staffManage.branchAccessAutomatic": "Lahat ng active locations",
  ...
  "branches.storefrontQr.copyLink": "Kopyahin ang link",

  "branches.storefrontQr.copied": "Nakopya ang link",

  "branches.storefrontQr.download": "I-download ang QR",

  "branches.storefrontQr.downloadFailed": "Hindi ma-download ang QR code.",
  ...
  "areas.open": "Buksan ang area",

  "areas.capacity": "Kapasidad ng area",

  "areas.capacityOf": "{used} sa {allowed} aktibong area",
  ...
  "areas.status.archived": "Naka-archive",

  "areas.emptyTitle": "Wala pang area",
  ...
  "areas.createError": "Hindi nagawa ang area.",

  "areas.saveError": "Hindi na-save ang pagbabago.",

  "areas.archiveError": "Hindi na-archive ang area.",

  "areas.notFound": "Hindi nakita ang area na ito.",

  "areas.nameRequired": "Maglagay ng pangalan ng area.",

  "areas.denied": "Mga may-ari ng organisasyon lang ang makakapamahala ng mga area.",
  ...
  "areas.create.code": "Code ng area (opsyonal)",

  "areas.create.codeHelper": "Maikling malaking-titik na code na pang-loob, halimbawa NCR-NORTH.",

  "areas.create.submit": "Gumawa ng area",
  ...
  "areas.cancel": "Kanselahin",

  "areas.archive": "I-archive ang area",

  "areas.archiveConfirmTitle": "I-archive ang area na ito?",
  ...
  "branches.mgmt.viewQr": "Tingnan ang QR",
  ...
  "inventory.openRequestStock": "Humingi ng stock",
  "inventory.openIncomingStockRequests": "Mga papasok na stock request",
  "inventory.openStockRequests": "Mga stock request",
  "stockRequest.title": "Humingi ng stock",
  "stockRequest.lede": "Humingi ng stock mula sa supply warehouse.",
  "stockRequest.listTitle": "Mga stock request",
  "stockRequest.listLede": "Papasok at papalabas na internal stock request.",
  ...
  "stockRequest.loadError": "Hindi ma-load ang stock request.",
  "stockRequest.noSource": "Walang naka-configure na supply warehouse para sa location na ito.",
  "stockRequest.noSourceDetail": "Humingi sa admin na ikonekta ang warehouse sa Supply routes, o gumamit ng purchasing kung may access ka.",
  "stockRequest.createPo": "Gumawa ng purchase order",
  "stockRequest.receiveStock": "Tumanggap ng stock",
  "stockRequest.forLocation": "Para sa",
  "stockRequest.supplyFrom": "Kunan mula sa",
  "stockRequest.preferred": "preferred",
  "stockRequest.availableHere": "Available dito",
  "stockRequest.notes": "Notes (opsyonal)",
  "stockRequest.submit": "Isumite ang request",
  "stockRequest.submitError": "Hindi maisumite ang stock request.",
  "stockRequest.direction": "Direksyon",
  "stockRequest.incoming": "Papasok",
  "stockRequest.outgoing": "Papalabas",
  "stockRequest.empty": "Walang stock request",
  "stockRequest.emptyDetail": "Lalabas dito ang mga bagong request.",
  "stockRequest.emptyProducts": "Walang tumugmang produkto",
  "stockRequest.emptyProductsDetail": "Subukan ang ibang search o stock filter.",
  ...
  "stockRequest.remainingToDispatch": "Needs fulfillment",
  "stockRequest.needsFulfillmentSummary": "Needs fulfillment: {qty}",
  ...
  "stockRequest.waitingForDestination":
    "Naghihintay sa destination branch. {qty} units ang nasa transit pa sa Transfer {transfer}.",
  "stockRequest.viewOpenTransfer": "Tingnan ang transfer",
  "stockRequest.reviewPrepareTransfer": "Suriin at ihanda ang transfer",
  "stockRequest.continueTransferPreparation": "Ipagpatuloy ang paghahanda ng transfer",
  "stockRequest.fulfillRemaining": "Tuparin ang natitirang {qty}",
  "stockRequest.readyToReceive": "Handa nang tumanggap",
  "stockRequest.linkedTransfer.sent": "Ipinadala",
  "stockRequest.linkedTransfer.received": "Natanggap",
  "stockRequest.linkedTransfer.closed": "Isinara",
  ...
  "stockRequest.tab.inProgress": "Kasalukuyan",
  "stockRequest.tab.inTransit": "Papunta",
  "stockRequest.tab.completed": "Tapos na",
  "stockRequest.tab.all": "Lahat",
  "stockRequest.tab.incoming": "Papasok",
  "stockRequest.tab.preparing": "Inihahanda",
  "stockRequest.tab.dispatched": "Naipadala",
  "stockRequest.tab.history": "Kasaysayan",
  "stockRequest.search": "Maghanap ng produkto",
  "stockRequest.filterLabel": "Stock filter",
  "stockRequest.filter.all": "Lahat",
  "stockRequest.filter.lowStock": "Kulang ang stock",
  "stockRequest.filter.outOfStock": "Walang stock",
  ...
  "stockRequest.activity.preparing": "Nagsimula ang paghahanda",
  "stockRequest.activity.dispatched": "Naipadala",
  "stockRequest.activity.rejected": "Tinanggihan",
  "stockRequest.activity.cancelled": "Kinansela",
  "stockRequest.activity.empty": "Wala pang aktibidad.",
  "stockRequest.activity.loadError": "Hindi ma-load ang aktibidad.",
  "stockRequest.activity.transferPrepared": "Inihanda ang transfer",
  "stockRequest.activity.transferDispatched": "Naipadala ang transfer",
  "stockRequest.activity.transferReceipt": "Receipt ng transfer",
  ...
  "stockRequest.activity.transferRemainderClosed": "Isinara ang natitirang transfer",
  "stockRequest.activity.transferCancelled": "Kinansela ang transfer",
  "stockRequest.activity.requestFulfilled": "Natupad ang request",
  "stockRequest.activity.transferRefDetail": "Transfer {transfer}",
  "stockRequest.actionError": "Hindi ma-update ang stock request na ito.",
  "stockRequest.status.pending": "Nakabinbin",
  "stockRequest.status.approved": "Naaprubahan",
  "stockRequest.status.preparing": "Inihahanda",
  "stockRequest.status.inTransit": "Papunta",
  "stockRequest.status.fulfilled": "Natupad",
  "stockRequest.status.partiallyFulfilled": "Bahagyang natupad",
  "stockRequest.status.rejected": "Tinanggihan",
  ...
  "retailWarehouse.nav.requestStock": "Humiling ng stock",
  "retailWarehouse.nav.myRequests": "Mga hiling ko",
  "retailWarehouse.nav.incoming": "Papasok na stock",
  "retailWarehouse.nav.history": "Kasaysayan",
  "retailWarehouse.thisBranch": "ang branch na ito",
  ...
  "retailWarehouse.supplyCard.requestStock": "Humiling ng stock",
  "retailWarehouse.needsAttention": "Kailangan ng pansin",
  "retailWarehouse.metric.submitted": "Naisumite",
  "retailWarehouse.metric.inProgress": "Isinasagawa",
  "retailWarehouse.metric.inTransit": "Nasa biyahe",
  "retailWarehouse.recentRequests": "Kamakailang hiling",
  "retailWarehouse.viewAll": "Tingnan lahat",
  ...
  "retailWarehouse.request.addNote": "+ Magdagdag ng tala",
  "retailWarehouse.request.weightAdd": "Idagdag sa hiling",
  ...
  "retailWarehouse.request.remainingCompact": "Natitira: {qty} {uom}",
  "retailWarehouse.request.remainingTooltip": "Available pagkatapos ng napiling request.",

  "retailWarehouse.request.fixAvailabilityBeforeSubmit":
    "Nagbago ang warehouse stock. Ayusin ang dami bago mag-submit.",
  "retailWarehouse.request.revalidateFailed": "Hindi ma-refresh ang warehouse availability. Subukan ulit.",
  ...
  "retailWarehouse.request.basketSummary": "{count} produkto",
  "retailWarehouse.request.basketEmpty": "Walang laman ang basket",
  "retailWarehouse.request.basketEmptyDetail": "Magdagdag ng produkto mula sa katalogo para gumawa ng hiling.",
  "retailWarehouse.request.add": "Idagdag",
  "retailWarehouse.request.added": "Naidagdag",
  "retailWarehouse.request.remove": "Alisin",
  "retailWarehouse.request.lineNotes": "Tala sa linya (opsyonal)",
  "retailWarehouse.request.category": "Kategorya",
  "retailWarehouse.request.categoryAll": "Lahat ng kategorya",
  "retailWarehouse.request.prev": "Nakaraan",
  "retailWarehouse.request.next": "Susunod",
  "retailWarehouse.request.viewRequest": "Tingnan ang hiling ({count})",
  "retailWarehouse.request.submitted": "Naisumite ang stock request.",
  "retailWarehouse.request.increase": "Dagdagan ang dami",
  ...
  "retailWarehouse.request.warehouseOutOfStock": "Walang stock sa warehouse",
  "retailWarehouse.request.costPerUom": "{amount}/{uom}",
  "retailWarehouse.request.retailPerUom": "Retail {amount}/{uom}",
  "retailWarehouse.request.lineEstimatedCost": "Tinatayang gastos",
  "retailWarehouse.request.linePotentialRetail": "Posibleng retail",
  "retailWarehouse.incoming.receiveHint": "Buksan para tumanggap ng stock",
  "retailWarehouse.history.search": "Hanapin ang request number",
  "warehouse.toast.noWarehouse.title": "Wala pang warehouse",
  "warehouse.toast.noWarehouse.description": "Magdagdag muna ng warehouse branch bago humiling ng stock.",
  "warehouse.toast.noWarehouse.askAdmin": "Humingi sa organization admin na magdagdag ng warehouse branch.",
  "warehouse.toast.noWarehouse.action": "I-manage ang mga branch",
  "warehouse.toast.noAssignment.title": "Walang naka-assign na warehouse",
  "warehouse.toast.noAssignment.description":
    "Walang supply warehouse route ang {branch}. I-configure ang supply routes para ikonekta ang warehouse.",
  "warehouse.toast.noAssignment.askManager":
    "Walang supply warehouse ang {branch}. Humingi sa manager na i-configure ang supply routes.",
  ...
  "catalog.category.creating": "GumagawaÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦",
  ...
  "production.recipes.sellingBelowCostDetail": "Cost: {cost} Ãƒâ€šÃ‚Â· Selling price: {price} Ãƒâ€šÃ‚Â· Estimated loss: {loss} / {uom}",
  ...
  "customers.business.actionRequired": "Action required ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â {name} wants to connect.",
  ...
  "returns.connectedPo.sectionTitle": "Mga return sa supplier",
  "returns.connectedPo.returnItems": "Ibalik ang mga item sa supplier",
  "returns.connectedPo.requestTitle": "Ibalik sa supplier",
  "returns.connectedPo.requestLede": "Piliin ang mga natanggap na item na ibabalik mo.",
  "returns.connectedPo.returnableQty": "Maaaring ibalik",
  "returns.connectedPo.receivedQty": "Natanggap",
  "returns.connectedPo.alreadyReturned": "Naibalik na",
  "returns.connectedPo.noReturnableLines": "Walang natanggap na item na maaaring ibalik.",
  "returns.connectedPo.blocked": "Hindi pa maaaring ibalik ang purchase order na ito.",
  "returns.connectedPo.submitRequest": "Ipadala ang return request",
  "returns.connectedPo.requestSent": "Naipadala na sa supplier ang return request.",
  "returns.connectedPo.sellerInboxTitle": "Mga papasok na return ng buyer",
  "returns.connectedPo.sellerInboxEmpty": "Walang naghihintay na return ng buyer.",
  "returns.connectedPo.process": "Iproseso",
  "returns.connectedPo.markReceived": "Kumpirmahin ang pagtanggap ng goods",
