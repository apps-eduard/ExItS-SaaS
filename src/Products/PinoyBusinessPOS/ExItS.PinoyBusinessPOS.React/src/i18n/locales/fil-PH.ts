...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "uiStandards.tabsPilotBadge": "TABS STANDARD — PILOT / NOT LOCKED",
  "uiStandards.tabsPilotLede": "Visual pilot for ExItS tab navigation. Five variants, CountBadge counts, keyboard/ARIA, theme and density from Preferences. Do not treat as locked until approved.",
  ...
  "uiStandards.tabsCheatLede": "Candidate vocabulary for Cursor tasks. PILOT — not locked.",
