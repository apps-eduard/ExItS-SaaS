...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "uiStandards.tableDemoLede": "Approved ExitsTable reference with search, filter, sort, multi-select, output icons, and pagination.",
  ...
  "uiStandards.tableCheatLede": "Use these terms in Cursor tasks. Explicit ON/OFF overrides FULL TABLE defaults.",
