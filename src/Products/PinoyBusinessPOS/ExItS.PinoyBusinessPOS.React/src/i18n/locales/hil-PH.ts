...
export const hilPH: Record<keyof typeof en, string> = {
  ...
  "catalog.businessUsage.resale": "Ibaligya nga wala ginausab",
  "catalog.businessUsage.resaleHint": "Mabakal sang kostumer ang mismo nga produkto.",
  ...
  "catalog.businessUsage.filterResale": "Ibaligya nga wala ginausab",
