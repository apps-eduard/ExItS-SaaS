...
export const hilPH: Record<keyof typeof en, string> = {
  ...
  "catalog.packagesLede": "Ang tanang packages mogamit sang usa ka base inventory pool. Ang multiplier mo-convert sa gisulod nga quantity ngadto sa base units.",
  ...
  "customers.createKindWalkIn": "Walk-in (wala ExItS ID)",
...
"offline.todoWillQueue": "Offline ka. Magapabilin ini nga to-do sa device tubtob makakonektar ka.",
  ...
  "store.landing.lede": "Magpadayon sa ExItS agud maka-order sa sini nga negosyo.",
