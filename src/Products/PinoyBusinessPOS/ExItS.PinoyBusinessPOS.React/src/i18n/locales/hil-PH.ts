...
export const hilPH: Record<keyof typeof en, string> = {
  ...
  "branches.mapFallback": "Wala sing naka-configure nga map tiles. Ibutang ang coordinates ukon gamiton ang GPS isa ka beses, dayon buksan ang external map link.",
  "branches.mapHint": "Ang coordinates naga-identify sang ginhalinan sang fulfillment. Indi ini gina-kuha sa address.",
