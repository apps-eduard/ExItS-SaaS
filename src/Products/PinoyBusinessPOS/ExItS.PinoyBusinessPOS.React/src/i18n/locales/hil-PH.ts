...
export const hilPH: Record<keyof typeof en, string> = {
  ...
  "uiStandards.cardsPilotBadge": "CARD STANDARD — PILOT / INDI PA LOCKED",
  "uiStandards.cardsPilotLede": "Visual pilot para sa ExItS cards. Treatments, KPI/entity/product patterns, selectable kag status accents. Theme kag density hali sa Preferences. Indi pagdakpon nga locked hasta ma-approve.",
  ...
  "uiStandards.cardsCheatLede": "Candidate vocabulary para sa Cursor tasks. PILOT — indi pa locked.",
