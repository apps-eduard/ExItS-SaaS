...
export const hilPH: Record<keyof typeof en, string> = {
  ...
  "connectivity.reconnecting": "Nagakonekta liwatÖ",
  ...
  "checkout.confirmingTransaction": "Gina-confirm ang transaksyonÖ",
  ...
  "devices.registerHint": "Signing in does not use a device slot. Explicit registration does ó and it stays on this browser across tabs and reloads.",
  ...
  "loading.preparingWorkspace": "[HIL] Preparing your workspaceÖ",
  "loading.switchingWorkspace": "[HIL] Switching workspaceÖ",
  "loading.updating": "[HIL] UpdatingÖ",
  "loading.working": "[HIL] WorkingÖ",
...
"offline.todoWillQueue": "Offline ka. Magapabilin ini nga to-do sa device tubtob makakonektar ka.",
  ...
  "onboarding.loading": "Loading setupù",
  ...
  "personal.home.storesLoading": "Loading store balancesÖ",
  ...
  "personal.ownershipTransfers.staleConflict":
    "Nagbag-o ang transfer. Na-refresh ang lista ó usisa liwat.",
  ...
  "personal.utang.accountsLoading": "Loading accountsÖ",
  ...
  "shift.pwaRegisterPreparing": "Creating PWA-0001Ö",
