...
export const hilPH: Record<keyof typeof en, string> = {
  ...
  "connected.exposableNotSharedNote": "Ang eligible nga produkto indi pa shared hasta nga imo paipaambit. Ang pagbaton indi magbag-o sang inventory.",
  ...
  "customers.lede": "Pangita sang customers, tan-awa ang Business Utang, kag i-record ang payments.",
