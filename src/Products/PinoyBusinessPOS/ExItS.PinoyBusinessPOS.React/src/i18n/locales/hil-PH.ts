...
export const hilPH: Record<keyof typeof en, string> = {
  ...
  "branches.deliveryAreas.regionSearchPlaceholder": "Pangita sang rehiyon…",
  ...
  "branches.deliveryAreas.regionsLoading": "Nagaload sang mga rehiyon…",
  ...
  "branches.deliveryAreas.citiesLoading": "Nagaload sang mga syudad…",
  ...
  "customers.orgNeedsBuyerConnection":
    "Kinahanglan sang Active supplier connection para sa Direct B2B checkout. Sugua ini nga organization nga mag-connect sa imo sa Suppliers, dayon batuna ang request. Pagkatapos, magapakita sila sa Customers ÃƒÂ¢Ã‚Â†Ã‚Â’ Businesses kag sa Sell checkout.",
  ...
  "customers.receivables.loading": "Nagaload sang receivables…",
...
"customers.statementTitle": "Customer statement",
  ...
  "uiStandards.actionChipsPilotBadge": "ACTION CHIP ÃƒÂ¢Ã‚Â€Ã‚Â” PILOT / CANDIDATE (Hiligaynon)",
  "uiStandards.actionChipsPilotLede": "ExItS Action Chip pilot (ExitsChipBar variant=actions + ActionChipBar). Magaan nga actions kag navigation shortcuts ÃƒÂ¢Ã‚Â€Ã‚Â” indi Tabs, Filters, Module Subnav, ukon Buttons. Theme kag density hali sa Preferences. PILOT / CANDIDATE ÃƒÂ¢Ã‚Â€Ã‚Â” Docs/UI/exits-action-chip-standard.md.",
  "uiStandards.actionChipsOverviewTitle": "Semantic overview (Hil)",
  "uiStandards.actionChipsOverviewLede": "Action vs navigation action vs filter vs button ÃƒÂ¢Ã‚Â€Ã‚Â” pareho ang label, lain ang trabaho.",
  ...
  "uiStandards.actionChipsShapesLede": "Pill, soft, kag square ÃƒÂ¢Ã‚Â€Ã‚Â” reuse sang locked Chip shape language nga may action touch targets.",
  ...
  "uiStandards.cardsPilotLede": "Canonical ExItS Card foundation. Treatments, KPI/entity/product patterns, selectable kag status accents, motion. Theme kag density hali sa Preferences. APPROVED / LOCKED ÃƒÂ¢Ã‚Â€Ã‚Â” Docs/UI/exits-card-standard.md.",
