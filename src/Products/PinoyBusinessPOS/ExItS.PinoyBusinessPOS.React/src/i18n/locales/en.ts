export const en = {
  ...
  "catalog.branchPricing.hint":
    "Set a custom selling price for {branch} only. Other branches keep the organization default unless they have their own custom price.",
  ...
  "catalog.branchPricing.inheritedByBranches":
    "Inherited by branches without a custom price.",
  ...
  "catalog.organizationPricing.hint":
    "Changing this updates the inherited price for every branch that does not have a custom branch price.",
