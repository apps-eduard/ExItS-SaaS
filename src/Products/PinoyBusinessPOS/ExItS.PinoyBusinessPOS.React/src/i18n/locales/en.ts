export const en = {
  ...
  "production.setups.noEligibleMaterials": "No eligible ingredients",
  "production.setups.noEligibleMaterialsDetail": "Mark products as ingredients (Can be used as ingredient) in catalog.",
