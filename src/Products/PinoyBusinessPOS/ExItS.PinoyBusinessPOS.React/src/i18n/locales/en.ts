export const en = {
  ...
  "staffAssign.allBranchesHint":
    "Dynamically includes every current and newly activated branch.",
  "staffAssign.areaScope": "Areas",
  "staffAssign.areaScopeHint":
    "Access follows the branches in the selected areas, including branches added later.",
