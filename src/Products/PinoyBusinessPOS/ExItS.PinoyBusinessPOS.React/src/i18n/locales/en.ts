export const en = {
  ...
  "areas.title": "Areas",
  "areas.singular": "Area",
  "areas.lede": "Group branches for staff access, navigation, and reporting.",
  "areas.groupingOnlyNote":
    "Areas group branches only. Stock, registers, shifts, and sales stay with each branch.",
  "areas.add": "Add area",
  ...
  "areas.branchCount": "{count} branches",
  "areas.unassigned": "Unassigned",
  "areas.unassignedCount": "{count} branches are not in any area.",
  "areas.status.active": "Active",
  "areas.status.archived": "Archived",
  "areas.emptyTitle": "No areas yet",
  "areas.emptyDetail": "Add an area when you want to group branches for staff access.",
  ...
  "areas.archiveConfirmDetail":
    "Remove every branch and staff area access first. Archiving never deletes branches or moves stock.",
  "areas.archiveConfirmAction": "Archive area",
  "areas.detail.title": "Area",
  "areas.detail.lede": "Assign, move, or remove branches. Nothing operational moves with them.",
  "areas.detail.branches": "Branches in this area",
  "areas.detail.noBranches": "No branches are in this area yet.",
  "areas.detail.availableBranches": "Other branches",
  "areas.detail.assign": "Add",
  "areas.detail.move": "Move here",
