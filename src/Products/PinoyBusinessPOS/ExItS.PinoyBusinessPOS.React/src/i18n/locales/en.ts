export const en = {
  ...
  "uiStandards.cardsPilotLede": "Visual pilot for ExItS cards. Treatments, KPI/entity/product patterns, selectable and status accents. Theme and density from Preferences. Do not treat as locked until approved.",
