export const en = {
  ...
  "orgSubscription.plansEmpty": "No other plans are published right now.",
  "orgSubscription.planUpgrade": "Higher plan",
  "orgSubscription.planDowngrade": "Lower plan",
  "orgSubscription.planLimits":
    "Branches {branches} · Staff {staff} · Devices {devices} · Areas {areas}",
  "orgSubscription.compare": "Check impact",
  "orgSubscription.comparing": "Checking impact…",
  "orgSubscription.previewError": "Could not check the impact of this plan right now.",
  "orgSubscription.previewBlockedTitle": "This plan cannot be applied yet",
  "orgSubscription.previewBlockedDetail":
    "Your current usage is above what {plan} allows. Nothing was changed. Reduce usage first, or stay on your current plan.",
  "orgSubscription.previewOkTitle": "No blocking conflicts",
  "orgSubscription.previewOkDetail": "Your current usage fits {plan}.",
  "orgSubscription.previewLostFeatures": "Features you would lose",
  "orgSubscription.changeManagedTitle": "Plan changes are applied by ExItS",
  "orgSubscription.changeManagedDetail":
    "This app does not process subscription payments. Contact ExItS to move to another plan.",
  "orgSubscription.billingManagedTitle": "Billing is managed by ExItS.",
  "orgSubscription.billingManagedDetail":
    "There is no self-service payment method or card on file in this app. Contact ExItS for billing changes, receipts, or payment questions.",
  "orgSubscription.invoicesEmptyTitle": "No invoices to show",
  "orgSubscription.invoicesEmptyDetail":
    "ExItS does not publish subscription invoices to this app yet. Store sales and supplier payables are not subscription invoices.",
  ...
  "incomingOrders.detailLede": "Review the order snapshot from the buyer. Accepting does not change inventory.",
