...
public static class StockMovementPresentation
{
    public static string ToFriendlyLabel(string? movementTypeCode)
    {
        ...
        return type switch
        {
            ...
            StockMovementType.TransferExceptionHold => "Wrong item received",
            StockMovementType.TransferExceptionExpectedRestore => "Expected item restored",
            StockMovementType.TransferExceptionActualOut => "Wrong item sent",
            StockMovementType.TransferExceptionReturnOut => "Wrong item returned to source",
            StockMovementType.TransferExceptionReturnIn => "Wrong item return received",
