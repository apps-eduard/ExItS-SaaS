...
public static class DependencyInjection
{
        ...
        IConfiguration config)
    {
        ...
        services.AddScoped<IBusinessCreditEntryRepository, BusinessCreditEntryRepository>();
        services.AddScoped<IBusinessRepaymentRepository, BusinessRepaymentRepository>();
        ...
        services.AddScoped<IBusinessCustomerCreditPolicyRepository, BusinessCustomerCreditPolicyRepository>();
        ...
        services.AddScoped<IInventoryTransferExceptionCustodyRepository, InventoryTransferExceptionCustodyRepository>();
