...
namespace ExItS.PinoyBusinessPOS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260730181424_AddPosSimpleSales")]
    partial class AddPosSimpleSales
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExItS.PinoyBusinessPOS.Infrastructure.Persistence.Sales.SaleRecord", b =>
                {
                    ...
                    b.ToTable("sales", "pos", t =>
                        {
                            t.HasCheckConstraint("ck_sales_payment_method", "payment_method IN ('Cash', 'ManualGCash')");

                            t.HasCheckConstraint("ck_sales_status", "status IN ('Completed', 'Voided')");

                            t.HasCheckConstraint("ck_sales_tender_consistency", "(payment_method = 'Cash' AND amount_tendered IS NOT NULL AND change_amount IS NOT NULL AND amount_tendered >= total AND gcash_reference IS NULL) OR (payment_method = 'ManualGCash' AND amount_tendered IS NULL AND change_amount IS NULL)");
