...
/// <summary>
/// MB2-02B-H2 cutover: reconstruct branch <c>reserved_quantity</c> from active
/// Reserved Sales / CustomerOrders. Does not change OnHand, ProductIds, or movements.
/// Fails closed on unresolved sale branch, missing balance, over-reserve, or org mismatch.
/// </summary>
[DbContext(typeof(PosDbContext))]
[Migration("20260901133000_ReconcileBranchInventoryReservations")]
public partial class ReconcileBranchInventoryReservations : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            CREATE TEMP TABLE tmp_branch_reservation_cutover ON COMMIT DROP AS
            SELECT
              src.organization_id,
              src.branch_id,
              src.product_id,
            ...
            BEGIN
              IF EXISTS (
                SELECT 1
                FROM tmp_branch_reservation_cutover t
              ...
              IF EXISTS (
                ...
                LEFT JOIN (
                  ...
                  FROM tmp_branch_reservation_cutover
    ...
    {
        // Restore pre-H2 / post-H1 cutover state: branch reserved overlay cleared.
        // OnHand, ProductId, sales/orders, and StockMovements are untouched.
        migrationBuilder.Sql(
            """
