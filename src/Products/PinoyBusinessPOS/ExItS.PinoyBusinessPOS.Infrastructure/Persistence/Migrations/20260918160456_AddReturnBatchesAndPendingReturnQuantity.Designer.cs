...
namespace ExItS.PinoyBusinessPOS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260918160456_AddReturnBatchesAndPendingReturnQuantity")]
    partial class AddReturnBatchesAndPendingReturnQuantity
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("return_batches", "pos", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_return_batches_status", "status IN ('PendingInspection', 'ReadyForFinalize', 'Finalized')");
                        });
                });
