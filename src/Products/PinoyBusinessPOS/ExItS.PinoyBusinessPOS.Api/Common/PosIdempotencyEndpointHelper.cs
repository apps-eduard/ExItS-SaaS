...
internal static class PosIdempotencyEndpointHelper
{
    ...
    private static string? ExtractServerReference<TDto>(TDto dto) => dto switch
    {
        ...
        Application.Payments.BusinessRepaymentDto br => br.RepaymentId.ToString("D"),
        ...
        Application.Inventory.StockUseDto su => su.StockUseId.ToString("D"),
        Application.Inventory.WasteLossDto wl => wl.WasteLossId.ToString("D"),
        Application.Inventory.ProductionRunDto pr => pr.ProductionRunId.ToString("D"),
