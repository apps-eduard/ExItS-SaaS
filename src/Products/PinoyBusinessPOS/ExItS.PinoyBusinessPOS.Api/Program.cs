...
using ExItS.PinoyBusinessPOS.Api.SupplierPayables;
...
using ExItS.PinoyBusinessPOS.Api.Onboarding;
...
builder.Services.AddScoped<DisableCustomerCreditPolicy>();
builder.Services.AddScoped<ListCustomerCreditPolicyHistory>();
builder.Services.AddScoped<GetBusinessCustomerCreditPolicy>();
builder.Services.AddScoped<UpsertBusinessCustomerCreditPolicy>();
builder.Services.AddScoped<ApproveBusinessCustomerCreditPolicy>();
builder.Services.AddScoped<DisableBusinessCustomerCreditPolicy>();
builder.Services.AddScoped<ListBusinessCustomerCreditPolicyHistory>();
builder.Services.AddScoped<GetBusinessCustomerStatement>();
...
builder.Services.AddScoped<ClearCheckRepayment>();
builder.Services.AddScoped<BounceCheckRepayment>();
builder.Services.AddScoped<CancelCheckRepayment>();
builder.Services.AddScoped<ReverseRepayment>();
builder.Services.AddScoped<BusinessOutstandingBalanceService>();
builder.Services.AddScoped<ConnectedB2bPaymentMirror>();
builder.Services.AddScoped<ConnectedB2bDirectPurchaseCreditSync>();
builder.Services.AddScoped<CreateBusinessRepayment>();
builder.Services.AddScoped<ClearBusinessCheckRepayment>();
builder.Services.AddScoped<BounceBusinessCheckRepayment>();
builder.Services.AddScoped<CancelBusinessCheckRepayment>();
builder.Services.AddScoped<BusinessRepaymentQueryService>();
builder.Services.AddScoped<WriteOffQueryService>();
builder.Services.AddScoped<CreateWriteOff>();
builder.Services.AddScoped<ReverseWriteOff>();
...
builder.Services.AddScoped<ListOrganizationPaymentMethods>();
builder.Services.AddScoped<UpsertOrganizationPaymentMethodSetting>();
builder.Services.AddScoped<ResolveCheckoutPaymentMethods>();
...
builder.Services.AddScoped<ProductBrandQueryService>();
builder.Services.AddScoped<CreateProductBrand>();
builder.Services.AddScoped<UpdateProductBrand>();
builder.Services.AddScoped<DeactivateProductBrand>();
builder.Services.AddScoped<ReactivateProductBrand>();
...
builder.Services.AddScoped<PartyBranchHistoryScopeService>();
builder.Services.AddScoped<IPartyBranchAccessActorAccessor, PartyBranchAccessActorAccessor>();
...
builder.Services.AddScoped<SetBranchProductPriceOverride>();
builder.Services.AddScoped<RemoveBranchProductPriceOverride>();
builder.Services.AddScoped<GetBranchProductPricing>();
...
builder.Services.AddScoped<QueryCatalogProductNameConflict>();
...
builder.Services.AddScoped<BranchReadinessQueryService>();
builder.Services.AddScoped<BranchSetupProgressService>();
builder.Services.AddScoped<PartyBranchExplicitAssignService>();
...
builder.Services.AddScoped<ReturnBatchQueryService>();
builder.Services.AddScoped<AcceptReturnBatch>();
builder.Services.AddScoped<ClassifyReturnBatchLine>();
builder.Services.AddScoped<FinalizeReturnBatch>();
...
builder.Services.AddScoped<GetInventoryBranchReorderDefault>();
builder.Services.AddScoped<SetInventoryBranchReorderDefault>();
builder.Services.AddScoped<ClearInventoryProductReorderOverride>();
builder.Services.AddScoped<BulkSetInventoryReorderConfiguration>();
builder.Services.AddScoped<DirectPurchaseReceiptQueryService>();
builder.Services.AddScoped<DirectPurchaseHistoryQueryService>();
builder.Services.AddScoped<CreateDirectPurchaseReceipt>();
builder.Services.AddScoped<VoidDirectPurchaseReceipt>();
builder.Services.AddScoped<CreateSupplierPayableFromReceipt>();
builder.Services.AddScoped<SupplierPayableSourceReferenceResolver>();
builder.Services.AddScoped<SupplierPayableQueryService>();
builder.Services.AddScoped<RecordSupplierPayablePayment>();
builder.Services.AddScoped<StockUseQueryService>();
builder.Services.AddScoped<CreateStockUse>();
builder.Services.AddScoped<VoidStockUse>();
builder.Services.AddScoped<WasteLossQueryService>();
builder.Services.AddScoped<CreateWasteLoss>();
builder.Services.AddScoped<VoidWasteLoss>();
builder.Services.AddScoped<ProductionDefinitionQueryService>();
builder.Services.AddScoped<CreateProductionDefinition>();
builder.Services.AddScoped<UpdateProductionDefinition>();
builder.Services.AddScoped<SetProductionDefinitionActive>();
builder.Services.AddScoped<ProductionRunQueryService>();
...
builder.Services.AddScoped<DispatchInventoryTransferDamageReturn>();
builder.Services.AddScoped<ReceiveInventoryTransferDamageReturn>();
builder.Services.AddScoped<InspectInventoryTransferDamageCustody>();
builder.Services.AddScoped<DispatchInventoryTransferExceptionReturn>();
builder.Services.AddScoped<ReceiveInventoryTransferExceptionReturn>();
builder.Services.AddScoped<InspectInventoryTransferExceptionCustody>();
builder.Services.AddScoped<SetInventoryTransferDamageHandlingPolicy>();
...
builder.Services.AddScoped<GetBusinessCustomerPaymentTimingOverride>();
builder.Services.AddScoped<UpdateBusinessCustomerPaymentTimingOverride>();
builder.Services.AddScoped<GetBusinessCustomerPricingOverrides>();
builder.Services.AddScoped<UpdateBusinessCustomerPricingOverrides>();
...
builder.Services.AddScoped<ConfirmIncomingOrderSettlement>();
builder.Services.AddScoped<ConfirmIncomingOrderReceiptSettlement>();
builder.Services.AddScoped<ConnectedPoInventoryReservationService>();
builder.Services.AddScoped<ConnectedPurchaseOrderFulfillStock>();
builder.Services.AddScoped<MarkIncomingOrderFulfilled>();
builder.Services.AddScoped<CloseIncomingOrderRemaining>();
builder.Services.AddScoped<ProposeIncomingOrderChanges>();
builder.Services.AddScoped<WithdrawIncomingOrderProposal>();
...
builder.Services.AddScoped<ExItS.PinoyBusinessPOS.Application.Reporting.ProductProfitabilityReportService>();
...
app.MapCustomerCreditPolicyEndpoints();
app.MapBusinessCustomerCreditPolicyEndpoints();
app.MapBusinessCustomerStatementEndpoints();
app.MapCustomerCreditSyncEndpoints();
app.MapDueDateEndpoints();
app.MapBusinessRepaymentEndpoints();
app.MapRepaymentEndpoints();
app.MapWriteOffEndpoints();
...
app.MapReturnBatchEndpoints();
app.MapConnectedPoReturnEndpoints();
app.MapInventoryEndpoints();
app.MapDirectPurchaseReceiptEndpoints();
app.MapDirectPurchaseHistoryEndpoints();
app.MapStockUseEndpoints();
app.MapWasteLossEndpoints();
app.MapProductionEndpoints();
app.MapExpenseEndpoints();
app.MapSupplierEndpoints();
app.MapSupplierPayableEndpoints();
app.MapConnectedSupplierEndpoints();
app.MapConnectedCommerceEndpoints();
