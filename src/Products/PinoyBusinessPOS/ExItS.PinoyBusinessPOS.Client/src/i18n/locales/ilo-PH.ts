...
export const iloPH: Record<keyof typeof en, string> = {
  ...
  "diagnostics.copyFailed": "Copy failed ù select the text below",
  ...
  "shell.connectionSync.offlineWaiting": "Offline ù {count} agur-uray",
  "shell.connectionSync.syncing": "Ag-syncù",
  ...
  "offline.cashOnlyTitle": "Offline ù Cash laeng",
  ...
  "offline.shiftContinued": "Offline ù agtultuloy ti shift {shift}",
  ...
  "session.loading": "Kitkitaen ti sessionù",
  ...
  "signIn.staffLoginHint":
    "Naduktalan ti staff login. Usaren ti organization staff password ù naisina daytoy iti ania man a Personal password.",
  "signIn.submit": "Sumrek / Sign in",
  "signIn.submitting": "Agsasarekù",
  ...
  "signIn.selectUser": "Agpili iti userù",
  ...
  "auth.forgotPasswordSubmitting": "Sendingù",
  ...
  "auth.signUpSubmitting": "Creating accountù",
  ...
  "staffInvite.lede":
    "Mangipatulod iti invitation ti organization staff. Ti contact email ket recovery laeng ù maparsua ti staff login no maawat.",
  ...
  "staffInvite.submitting": "Agaramidù",
  ...
  "staffAccept.submitting": "Umawatù",
  ...
  "qr.startingCamera": "Starting cameraù",
  ...
  "customers.personalLink.sending": "Sendingù",
  ...
  "personal.more.switchingBusiness": "Switchingù",
  ...
  "personal.explore.loading": "Loading plansù",
  ...
  "personal.startBusiness.loading": "Loading Start a Businessù",
  ...
  "personal.startBusiness.slugHiddenHint":
    "A unique organization slug is generated for you ù you do not need to enter one.",
  ...
  "personal.startBusiness.contactHelper":
    "Optional. Copied once into the organization profile ù not kept in sync later.",
  ...
  "personal.startBusiness.submitting": "Creatingù",
  ...
  "sell.checkoutReadinessReady":
    "Nakalukat a shift agraman register ù nakasagana para iti sumaruno a checkout.",
  "sell.checkoutReadinessMoneyReady":
    "Nakalukat a shift ken authorized device ù nakasagana para iti cash checkout.",
  ...
  "sell.linePreview": "{qty} {unit} ù ?{price}/{unit} = ?{amount}",
  ...
  "checkout.customerLoading": "Agkarkarga iti customersù",
  ...
  "checkout.optionalCustomerHint":
    "Opsional ù i-attach ti customer iti daytoy a Cash wenno GCash sale.",
  ...
  "checkout.quoteLoading": "Gina-update ti amountsù",
  ...
  "checkout.shiftHint": "Shift {shift} ù Register {register}",
  ...
  "checkout.confirming": "Gina-record ti saleù",
  ...
  "role.managerBody":
    "Operations lti by default. Ti Start selling moabli iti sell floor kung tugotan ti CreateSale ù saan a mausab ti ti Manager role.",
  ...
  "shift.registerPlaceholder": "Agpili iti registerù",
  ...
  "shift.readinessReady": "Nakasagana ù nakalukat a shift uban ti register.",
  "shift.readinessBlocked": "Nablock ù awan ti nakalukat a shift.",
  "shift.readinessDenied": "Nablock ù naiparit ti access iti shift.",
  ...
  "devices.branchPlaceholder": "Agpili iti branchù",
  ...
  "devices.registerHint":
    "Ti panag-sign in ket saan nga agusar iti device slot. Ti registration ti agusar ù ket agtalinaed iti daytoy a device kadagiti tab ken reload.",
  ...
  "devices.registering": "Gina-registerù",
  "devices.registerError": "Saan a ma-register daytoy a browser.",
  "devices.creatingCode": "Naaramid ti codeù",
  ...
  "sell.readiness.loading": "Masuksukimat ti panagsagana iti panaglakoù",
  ...
  "sell.viewOnlyBanner": "View only ù Irehistro daytoy a device tapno agilako",
  ...
  "sell.floatingCartSummary": "{count} a banag ù ?{subtotal}",
  ...
  "inventory.untrackedHint":
    "Ti not tracked pasabot a naka-off ti inventory enforcement ù saan a zero stock.",
  ...
  "inventory.expiryCounts": "Expired lots: {expired} ù Near expiry lots: {near}",
  ...
  "inventory.loadingMore": "Agkarkarga paù",
  ...
  "returns.submitting": "Gina-submitù",
  ...
  "returns.successGCash": "GCash refund ù kompletoen ti transfer manually ken note-i ti reference.",
  ...
  "purchasing.choiceReceive":
    "Receive stock when goods are already here ù inventory increases immediately.",
  "purchasing.choiceOrder":
    "Create a purchase order when you will receive later ù ordering alone does not add stock.",
  ...
  "purchasing.loading": "Loading purchasingù",
  ...
  "purchasing.receiving": "Receivingù",
  ...
  "branches.gpsWorking": "Agala iti lokasionù",
  ...
  "orders.quotingFee": "Calculating delivery feeù",
  ...
  "dashboard.lede": "Todayùs store overview and period totals from the server.",
  ...
  "dashboard.todaySales": "Todayùs sales",
  "dashboard.todayCash": "Todayùs cash",
  "dashboard.todayUtang": "Todayùs utang",
  ...
  "reports.lede": "Operational and classic reports. Online only ù no invented accounting.",
  ...
  "reports.loading": "Loading reportù",
