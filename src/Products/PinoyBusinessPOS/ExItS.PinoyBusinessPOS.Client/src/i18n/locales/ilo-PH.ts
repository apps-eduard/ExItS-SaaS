...
export const iloPH: Record<keyof typeof en, string> = {
  ...
  "diagnostics.globalHint":
    "Kopiaem ti report iti baba ken i-paste iti support wenno troubleshooting chat.",
  ...
  "staffAssign.ownerConfirmMessage":
    "Ti Owner ket agited ti napno a POS control. I-assign laeng kadagiti trusted a tattao.",
  ...
  "personal.utang.pendingConfirmationsLede":
    "Lukatan ti shared utang tapno kumpirmaen wenno i-dispute ti nairekord ti sabali.",
  ...
  "personal.utang.sendForConfirmationHint":
    "Masapul a kumpirmaen ti sabali sakbay a mabalbaliwan ti balanse.",
  ...
  "personal.social.reminderServerHint":
    "Ipaw-it ti ExItS daytoy a pannakaamang kas in-app notification iti naiskediula nga oras.",
  ...
  "personal.social.notif.customerLinkPreviewGeneric":
    "Adda tendaan a nangayon kenka kas customer ken kayatna nga i-link ti ExItS account-mo.",
  ...
  "personal.todo.reminderServerHint":
    "Mangipaw-it ti ExItS iti in-app notification iti daytoy nga oras bayat a naka-sign in ka.",
  ...
  "personal.customerLinks.lede":
    "Awaten ti tendaan tapno i-link ti Personal account-mo kas customerda. Ibabawi no saanmo a mabigbig.",
  "personal.customerLinks.listTitle": "Agur-uray",
  "personal.customerLinks.cardPrompt":
    "Kayat daytoy a tendaan nga i-link ti ExItS account-mo kas customerda.",
  "personal.customerLinks.acceptHint":
    "No awaten, bigbigenka ti tendaan para kadagiti order ken resibo. Saanna nga ited ti staff access.",
  "personal.customerLinks.emptyTitle": "Awan ti agur-uray a kiddaw iti link",
  "personal.customerLinks.emptyDetail":
    "No mangipatulod ti tendaan iti customer link request, agparang ditoy.",
  ...
  "customers.createKindLede":
    "Pilien ti walk-in (awan ExItS ID) wenno i-link ti Personal ExItS identity.",
  ...
  "personal.merchantsLede":
    "Gumatang kadagiti tendaan a naka-linkka. Saan a mairaman iti daytoy a package ti public storefront URL.",
  "personal.merchantsEmptyTitle": "Awan ti naka-konekta a tendaan",
  "personal.merchantsEmptyDetail":
    "No i-link ti business ti Personal account-mo kas customer, agparang ditoy tapno makapag-orderka.",
