...
export const hilPH: Record<keyof typeof en, string> = {
  ...
  "shell.connectionSync.offlineWaiting": "Offline ù {count} nagahulat",
  "shell.connectionSync.syncing": "Naga-syncù",
  ...
  "offline.cashOnlyTitle": "Offline ù Cash lang",
  ...
  "offline.shiftContinued": "Offline ù nagapadayon ang shift {shift}",
  ...
  "session.loading": "Gina-usisa ang sessionù",
  ...
  "signIn.staffLoginHint":
    "Nakita ang staff login. Gamita ang organization staff password ù lain ini sa bisan anong Personal password.",
  "signIn.submit": "Mag-sign in",
  "signIn.submitting": "Naga-sign inù",
  ...
  "signIn.selectUser": "Magpili sang userù",
  ...
  "staffInvite.lede":
    "Padala sang invitation sa organization staff. Ang contact email para recovery lang ù mabuhat ang staff login kon batunon.",
  ...
  "staffInvite.submitting": "Ginahimoù",
  ...
  "staffInvite.openAccept": "Abrùhi ang accept page",
  ...
  "staffAccept.submitting": "Ginabatonù",
  "staffAccept.error": "Indi mabatùn ang invitation.",
  "staffAccept.requiresPersonal":
    "Mag-sign in sa imo Personal account agud mabatùn ini nga invitation.",
  ...
  "personal.more.switchingBusiness": "Nagabalhinù",
  ...
  "personal.explore.loading": "Nagakarga sang plansù",
  ...
  "personal.startBusiness.loading": "Nagakarga sang Mag-umpisa Negosyoù",
  ...
  "personal.startBusiness.contactHelper":
    "Opsyonal. Kopyahon isa ka beses sa organization profile ù indi i-sync sa ulihi.",
  ...
  "personal.startBusiness.submitting": "Ginahimoù",
  ...
  "sell.checkoutReadinessReady":
    "Bukas nga shift upod ang register ù handa na para sa masunod nga checkout.",
  "sell.checkoutReadinessMoneyReady":
    "Bukas nga shift kag authorized device ù handa na para sa cash checkout.",
  ...
  "checkout.customerLoading": "Nagakarga sang customersù",
  ...
  "checkout.optionalCustomerHint":
    "Opsyonal ù i-attach ang customer sa sini nga Cash ukon GCash sale.",
  ...
  "checkout.quoteLoading": "Gina-update ang amountsù",
  ...
  "checkout.confirming": "Gina-record ang saleù",
  ...
  "role.managerBody":
    "Operations lang by default. Ang Start selling moabli sa sell floor kung tugotan ang CreateSale ù indi mausab ang imo Manager role.",
  ...
  "shift.registerPlaceholder": "Magpili sang registerù",
  ...
  "shift.readinessReady": "Handa ù bukas nga shift uban ang register.",
  "shift.readinessBlocked": "Ginablock ù wala sing bukas nga shift.",
  "shift.readinessDenied": "Ginablock ù ginaindian ang access sa shift.",
  ...
  "devices.branchPlaceholder": "Magpili sang branchù",
  ...
  "devices.registerHint":
    "Ang pag-sign in wala naggamit sang device slot. Ang registration ang naggamit ù kag nagapabilin ini sa device sa mga tab kag reload.",
  ...
  "devices.creatingCode": "Ginahimo ang codeù",
  ...
  "sell.readiness.loading": "Ginausisa ang kahanda sa pagbaligyaù",
  ...
  "sell.viewOnlyBanner": "View only ù Irehistro ini nga device para makabaligya",
  ...
  "sell.floatingCartSummary": "{count} ka butang ù ?{subtotal}",
  ...
  "inventory.untrackedHint":
    "Ang not tracked pasabot nga naka-off ang inventory enforcement ù indi zero stock.",
  ...
  "inventory.loadingMore": "Nagakarga paù",
  ...
  "returns.successGCash":
    "GCash refund ù kompletoha ang transfer manually kag note-i ang reference.",
  ...
  "branches.gpsWorking": "Naga-kuha sang lokasyonù",
