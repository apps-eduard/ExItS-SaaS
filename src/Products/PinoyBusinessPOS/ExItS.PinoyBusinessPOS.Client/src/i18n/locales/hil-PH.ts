...
export const hilPH: Record<keyof typeof en, string> = {
  ...
  "diagnostics.globalHint":
    "Kopyaha ang report sa idalom kag i-paste sa support o troubleshooting chat.",
  ...
  "staffAssign.ownerConfirmMessage":
    "Ang Owner nagahatag sang bug-os nga POS control. I-assign lang sa trusted nga tawo.",
  ...
  "personal.utang.pendingConfirmationsLede":
    "Buksan ang shared utang para kumpirmahon ukon i-dispute ang ginarekord sang pihak.",
  ...
  "personal.utang.sendForConfirmationHint":
    "Kinahanglan kumpirmahon sang pihak antes magbag-o ang balanse.",
  ...
  "org.notifications.lede":
    "Mga alerto sang negosyo para sa sini nga organisasyon ? suppliers, orders, kag customer links.",
  ...
  "org.notifications.unreadEmptyDetail":
    "Nakasunod ka na. Magbalhin sa Tanan agud tan-awon ang nauna nga mga pahibalo.",
  ...
  "personal.social.reminderServerHint":
    "Ipadala sang ExItS ini nga pahanumdom bilang in-app notification sa gintakda nga oras.",
  ...
  "personal.social.notif.customerLinkPreviewGeneric":
    "May tindahan nga nagdugang sa imo bilang customer kag gusto niya i-link ang imo ExItS account.",
  ...
  "personal.todo.reminderServerHint":
    "Magapadala ang ExItS sang in-app notification sa sini nga oras samtang naka-sign in ka.",
  ...
  "personal.customerLinks.lede":
    "Batuna ang tindahan para i-link ang imo Personal account bilang ila customer. Balibara kung indi mo ini kilala.",
  "personal.customerLinks.listTitle": "Naga-hulat",
  "personal.customerLinks.cardPrompt":
    "Gusto sini nga tindahan nga i-link ang imo ExItS account bilang ila customer.",
  "personal.customerLinks.acceptHint":
    "Kung batunon, kilalahon ka sang tindahan para sa mga order kag resibo. Indi ini maghatag sang staff access.",
  "personal.customerLinks.emptyTitle": "Wala sing naga-hulat nga pangabay sa link",
  "personal.customerLinks.emptyDetail":
    "Kung magpadala ang tindahan sang customer link request, makita ini diri.",
  ...
  "sell.info.cartNotHeld":
    "Ang quantity sa cart wala pa na-reserve. Makita pa sang iban nga register ang committed on-hand hasta sa checkout.",
  ...
  "org.lede":
    "Home sang Owner kag administrator ? tan-awa ang adlaw subong, insights, kag organization tools.",
  "org.badge": "Admin",
  "org.body":
  ...
  "customers.formLedeWalkIn":
    "Walk-in customer ? kinahanglan ang ngalan. Wala ExItS Personal link. Opsyonal ang mobile, address, kag notes.",
  "customers.formLedeExits":
    "I-link ang ExItS Personal ID pagkatapos ibutang ang display name. Kinahanglan i-Accept sang Personal user ang link request.",
  "customers.createKindTitle": "Klase sang customer",
  "customers.createKindLede":
    "Pilia ang walk-in (wala ExItS ID) ukon i-link ang Personal ExItS identity.",
  ...
  "connected.requestHelp":
    "I-scan ang Business QR sang supplier, mag-upload sang QR photo, ukon i-type ang organization ID (ORG######).",
  ...
  "personal.merchantsLede":
    "Magbakal sa mga tindahan nga naka-link ka. Wala sa package ini ang public storefront URL.",
  "personal.merchantsEmptyTitle": "Wala sing naka-konekta nga tindahan",
  "personal.merchantsEmptyDetail":
    "Kung i-link sang business ang imo Personal account bilang customer, mag-appear ini diri para makapang-order.",
