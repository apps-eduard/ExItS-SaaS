...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "diagnostics.globalHint":
    "Kopyahin ang ulat sa ibaba at i-paste sa support o troubleshooting chat.",
  ...
  "staffAssign.ownerConfirmMessage":
    "Binibigyan ng Owner ang buong POS control. I-assign lang sa trusted na tao.",
  ...
  "personal.utang.pendingConfirmationsLede":
    "Buksan ang shared utang para kumpirmahin o i-dispute ang naitala ng kabila.",
  ...
  "personal.utang.sendForConfirmationHint":
    "Kailangan kumpirmahin ng kabila bago magbago ang balanse.",
  ...
  "org.notifications.unreadEmptyDetail":
    "Updated ka na. Lumipat sa Lahat para makita ang mga dating notification.",
  ...
  "personal.social.reminderServerHint":
    "Ipapadala ng ExItS ang paalalang ito bilang in-app notification sa takdang oras.",
  ...
  "personal.social.notif.customerLinkPreviewGeneric":
    "May tindahang idinagdag ka bilang customer at gusto niyang i-link ang iyong ExItS account.",
  ...
  "personal.todo.reminderServerHint":
    "Magpapadala ang ExItS ng in-app notification sa oras na ito habang naka-sign in ka.",
  ...
  "personal.customerLinks.lede":
    "Tanggapin ang tindahan para i-link ang iyong Personal account bilang customer nila. Tanggihan kung hindi mo ito kilala.",
  "personal.customerLinks.listTitle": "Nakabinbin",
  "personal.customerLinks.cardPrompt":
    "Gusto ng tindahang ito na i-link ang iyong ExItS account bilang customer nila.",
  "personal.customerLinks.acceptHint":
    "Kapag tinanggap, makikilala ka ng tindahan para sa mga order at resibo. Hindi ito nagbibigay ng staff access.",
  "personal.customerLinks.emptyTitle": "Walang nakabinbing kahilingan sa link",
  "personal.customerLinks.emptyDetail":
    "Kapag may tindahang magpadala ng customer link request, lalabas ito dito.",
  ...
  "commercial.accessUnavailable":
    "Hindi namin ma-verify ang subscription access mo. Subukan ulit.",
  ...
  "sell.info.cartNotHeld":
    "Ang dami sa cart ay hindi pa reserved. Makikita pa ng ibang register ang committed on-hand hanggang sa checkout.",
  ...
  "customers.createKindLede":
    "Pumili ng walk-in (walang ExItS ID) o i-link ang Personal ExItS identity.",
  ...
  "connected.requestHelp":
    "I-scan ang Business QR ng supplier, mag-upload ng QR photo, o i-type ang organization ID (ORG######).",
  ...
  "personal.merchantsLede":
    "Mamili sa mga tindahang naka-link ka. Hindi kasama sa package na ito ang public storefront URL.",
  "personal.merchantsEmptyTitle": "Walang naka-konektang tindahan",
  "personal.merchantsEmptyDetail":
    "Kapag ini-link ng negosyo ang iyong Personal account bilang customer, lalabas ito dito para makapag-order.",
  ...
  "personal.merchantStatement.lede":
    "Natitirang balanse at mga kamakailang bili mula sa naka-link na tindahan (read-only).",
  ...
  "orders.missingLinkedCustomer":
    "Hindi pa naka-link ang account mo sa store na ito. Buksan ang Stores at tapusin ang pag-link, tapos subukan ulit.",
