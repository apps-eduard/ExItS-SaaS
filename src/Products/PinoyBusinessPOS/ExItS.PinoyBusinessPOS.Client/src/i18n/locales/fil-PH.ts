...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "shell.connectionSync.offlineWaiting": "Offline ù {count} naghihintay",
  "shell.connectionSync.syncing": "Sini-syncù",
  ...
  "offline.cashOnlyTitle": "Offline ù Cash lamang",
  ...
  "offline.shiftContinued": "Offline ù nagpapatuloy ang shift {shift}",
  ...
  "session.loading": "Sinusuri ang sessionù",
  ...
  "signIn.staffLoginHint":
    "Staff login ang nakita. Gamitin ang organization staff password ù hiwalay ito sa Personal password.",
  "signIn.submit": "Mag-sign in",
  "signIn.submitting": "Nagsa-sign inù",
  ...
  "signIn.selectUser": "Pumili ng userù",
  ...
  "staffInvite.lede":
    "Magpadala ng organization staff invitation. Ang contact email ay recovery lang ù staff login ay gagawin sa accept.",
  ...
  "staffInvite.submitting": "Gumagawaù",
  ...
  "staffAccept.submitting": "Tinatanggapù",
  ...
  "topbar.signingOut": "Nagsa-sign outù",
  ...
  "sell.checkoutReadinessReady": "May open shift at register ù handa para sa susunod na checkout.",
  "sell.checkoutReadinessMoneyReady":
    "May open shift at authorized device ù handa para sa cash checkout.",
  ...
  "checkout.customerLoading": "Naglo-load ng customersù",
  "checkout.customerEmpty": "Walang tumugmang active customer.",
  "checkout.customerClear": "Alisin ang customer",
  "checkout.optionalCustomerHint": "Opsyonal ù maglagay ng customer sa Cash o GCash sale.",
  ...
  "checkout.quoteLoading": "Ina-update ang mga halagaù",
  ...
  "checkout.confirming": "Nire-record ang saleù",
  ...
  "role.managerBody":
    "Operations lang by default. Ang Start selling ay bubuksan ang sell floor kapag allowed ang CreateSale ù hindi nagbabago ang Manager role.",
  ...
  "shift.registerPlaceholder": "Pumili ng registerù",
  ...
  "shift.readinessReady": "Ready ù may open shift at register.",
  "shift.readinessBlocked": "Blocked ù walang open shift.",
  "shift.readinessDenied": "Blocked ù denied ang shift access.",
  ...
  "devices.branchPlaceholder": "Pumili ng branchù",
  ...
  "devices.registerHint":
    "Ang pag-sign in ay hindi gumagamit ng device slot. Ang registration ang gumagamit ù at nananatili ito sa device na ito sa mga tab at reload.",
  ...
  "devices.registering": "Nire-registerù",
  "devices.registerError": "Hindi ma-register ang browser na ito.",
  "devices.creatingCode": "Gumagawa ng codeù",
  ...
  "sell.readiness.loading": "Sinusuri ang kahandaan sa pagbebentaù",
  ...
  "sell.viewOnlyBanner": "View only ù Irehistro ang device na ito para makapagbenta",
  ...
  "sell.floatingCartSummary": "{count} item ù ?{subtotal}",
  ...
  "inventory.untrackedHint":
    "Ang Not tracked ay nangangahulugang naka-off ang enforcement ù hindi zero stock.",
  ...
  "inventory.loadingMore": "Naglo-load paù",
  ...
  "connected.sending": "Ipinapadalaù",
  ...
  "returns.submitting": "Sinese-submitù",
  ...
  "returns.successGCash":
    "GCash refund ù kumpletuhin ang transfer nang manual at i-note ang reference.",
  ...
  "purchasing.choiceReceive":
    "Tumanggap ng stock kapag nandito na ang goods ù agad tumataas ang inventory.",
  "purchasing.choiceOrder":
    "Gumawa ng purchase order kung tatanggap ka mamaya ù ang pag-order lang ay hindi nagdadagdag ng stock.",
  ...
  "purchasing.loading": "Naglo-load ng pagbiliù",
  ...
  "purchasing.saving": "Sinese-saveù",
  ...
  "purchasing.receiving": "Tumanggapù",
  ...
  "branches.gpsWorking": "Kinukuha ang lokasyonù",
