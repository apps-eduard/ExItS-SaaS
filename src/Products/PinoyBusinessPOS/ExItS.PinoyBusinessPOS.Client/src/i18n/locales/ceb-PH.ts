...
export const cebPH: Record<keyof typeof en, string> = {
  ...
  "shell.connectionSync.offlineWaiting": "Offline ù {count} naghulat",
  ...
  "offline.shiftContinued": "Offline ù nagpadayon ang shift {shift}",
  ...
  "session.loading": "Gisusi ang sessionù",
  ...
  "signIn.staffLoginHint":
    "Nakita ang staff login. Gamita ang organization staff password ù bulag kini sa bisan unsang Personal password.",
  ...
  "signIn.selectUser": "Pagpili og userù",
  ...
  "staffInvite.lede":
    "Padad-i og invitation ang organization staff. Ang contact email para recovery lang ù mahimo ang staff login inig dawaton.",
  ...
  "staffInvite.submitting": "Gihimoù",
  ...
  "staffAccept.submitting": "Ginadawatù",
  ...
  "personal.more.switchingBusiness": "Nagbalhinù",
  ...
  "personal.explore.loading": "Nagkarga og plansù",
  ...
  "personal.startBusiness.loading": "Nagkarga sa Start a Businessù",
  ...
  "personal.startBusiness.contactHelper":
    "Opsyonal. Kopyahon kausa ngadto sa organization profile ù dili i-sync unya.",
  ...
  "personal.startBusiness.submitting": "Gihimoù",
  ...
  "account.switchingPersonal": "Gibalhinù",
  ...
  "sell.checkoutReadinessReady":
    "Abierto nga shift uban ang register ù andam na para sa sunod nga checkout.",
  "sell.checkoutReadinessMoneyReady":
    "Abierto nga shift ug authorized device ù andam na para sa cash checkout.",
  ...
  "checkout.customerLoading": "Nagkarga og customersù",
  "checkout.customerEmpty": "Walay nahaum nga active customers.",
  "checkout.customerClear": "Kuhaa ang customer",
  "checkout.optionalCustomerHint": "Opsyonal ù i-attach ang customer niining Cash o GCash sale.",
  ...
  "role.managerBody":
    "Operations lang by default. Ang Start selling moabli sa sell floor kung tugotan ang CreateSale ù dili mausab ang imong Manager role.",
  ...
  "shift.registerPlaceholder": "Pagpili og registerù",
  ...
  "shift.readinessReady": "Andam ù abierto nga shift uban ang register.",
  "shift.readinessBlocked": "Gibabagan ù walay abierto nga shift.",
  "shift.readinessDenied": "Gibabagan ù gidili ang access sa shift.",
  ...
  "devices.branchPlaceholder": "Pagpili og branchù",
  ...
  "devices.registerHint":
    "Ang pag-sign in dili mogamit og device slot. Ang registration ang mogamit ù ug magpabilin kini niini nga device sa mga tab ug reload.",
  ...
  "devices.creatingCode": "Gihimo ang codeù",
  ...
  "sell.readiness.loading": "Gisusi ang kahanda sa pagbaligyaù",
  ...
  "sell.viewOnlyBanner": "View only ù Irehistro kini nga device aron makabaligya",
  ...
  "inventory.untrackedHint":
    "Ang not tracked pasabot nga naka-off ang inventory enforcement ù dili zero stock.",
  ...
  "inventory.loadingMore": "Nagkarga paù",
  ...
  "returns.successGCash":
    "GCash refund ù kompletoha ang transfer manually ug note-i ang reference.",
  ...
  "branches.gpsWorking": "Nagkuha sa lokasyonù",
