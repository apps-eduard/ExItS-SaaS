...
export const cebPH: Record<keyof typeof en, string> = {
  ...
  "org.more.staff": "Imbitaha ang staff",
  ...
  "personal.social.unreadEmptyDetail":
    "Nakaabot ka na. Adto sa Tanan aron makita ang daan nga pahibalo.",
  ...
  "personal.explore.selectHint":
    "Sugdi ang trial kung available. Ang bayad nga subscribe naggamit og Local Validation payment sa non-production lang.",
  ...
  "personal.explore.paymentUnavailable":
    "Dili available ang bayad nga subscribe kung walay configured payment provider.",
  "personal.explore.paymentNote":
    "Wala pa ang production payment providers. Ang trial activation dili mag-charge og card.",
  "personal.explore.localValidationNote":
    "Local Validation mode: Ang Subscribe naggamit og simulated payment provider (dili production card charge).",
  ...
  "personal.startBusiness.contactHelper":
    "Opsyonal. Kopyahon kausa ngadto sa organization profile ? dili i-sync unya.",
  ...
  "personal.startBusiness.confirmHint":
    "Kompirma aron himoon ang organization, i-activate ang POS access, ug ablihi ang workspace.",
  ...
  "personal.startBusiness.planRequiredDetail":
    "Ablihi ang Explore POS plans, pilia ang trial o Local Validation subscribe, dayon padayon.",
  ...
  "commercial.accessUnavailable":
    "Dili namo ma-verify ang imong subscription access. Sulayi pag-usab.",
  ...
  "devices.registerThisDevice": "Irehistro kini nga device",
  "devices.registerTitle": "Irehistro kini nga device",
  "devices.registerLede":
    "Irehistro kini nga telepono, tablet, laptop, o computer sa dili pa kini makabaligya sa POS.",
  "devices.registerHint":
    "Ang pag-sign in dili mogamit og device slot. Ang registration ang mogamit ? ug magpabilin kini niini nga device sa mga tab ug reload.",
  ...
  "devices.currentDevice.activeTitle": "Narehistro kini nga device",
  "devices.currentDevice.activeDetail": "Makabaligya kini nga browser gikan sa {branch}.",
  "devices.currentDevice.revokedTitle": "Gibawi kini nga device",
  "devices.currentDevice.revokedDetail":
    "Dili makabaligya kini nga browser hangtod nga imo kining irehistro pag-usab.",
  "devices.currentDevice.registerAgain": "Irehistro pag-usab kini nga browser",
  "devices.currentDevice.unregisteredTitle": "Irehistro kini nga browser",
  ...
  "devices.revoke.passwordHint":
    "Kumpirmaha nga ikaw gyud kini. Ang imong password wala gitipigan niini nga device.",
  ...
  "devices.revoke.warning":
    "Kon mabawi, dili na makabaligya kini nga device. Kinahanglan kining irehistro pag-usab sa staff.",
  "devices.revoke.warningCurrentDevice":
    "Kini ang browser nga imong gigamit karon. Kon mabawi, dihadiha ma-block ang pagbaligya dinhi ug kinahanglan nimo kining irehistro pag-usab.",
  "devices.revoke.noPassword":
    "Wala pay password ang imong account, mao nga dili makumpirma dinhi kini nga aksyon. Pahumana sa platform administrator ang setup sa imong account.",
  "devices.revoke.credentialCheckFailed":
    "Dili masusi ang imong account sa dili pa mobawi. Sulayi pag-usab karon dayon.",
  ...
  "devices.revoke.consumed":
    "Nagamit na kana nga kumpirmasyon. Isulod pag-usab ang imong password.",
  ...
  "devices.revoke.unavailable":
    "Dili makumpirma ang imong password karon. Sulayi pag-usab karon dayon.",
  "devices.revoke.successCurrentDevice":
    "Gibawi kini nga browser. Irehistro pag-usab kon andam ka na nga mobaligya dinhi.",
  ...
  "sell.readiness.shiftHelp":
    "Gikinahanglan ang abierto nga shift sa dili pa makahimo ug makabayad og baligya.",
  ...
  "personal.merchantStatement.openPurchases": "Mga purchase ug activity",
  "personal.merchantStatement.title": "Merchant activity",
  "personal.merchantStatement.lede":
    "Outstanding balance ug recent purchases gikan sa linked store (read-only).",
  ...
  "personal.merchantStatement.openDebtEmptyDetail":
    "Naay outstanding balance, pero walay open-debt activity rows nga gibalik.",
  "personal.merchantStatement.recentSection": "Recent activity",
  "personal.merchantStatement.recentEmptyTitle": "Walay recent activity",
  "personal.merchantStatement.recentEmptyDetail":
    "Makita dinhi ang recent purchases ug Utang activity kung available.",
  ...
  "personal.merchantStatement.olderEmptyDetail":
    "Walay mas daan nga settled activity nga gibalik para niining store.",
  "personal.merchantStatement.historyLockedTitle": "Extended history locked",
  "personal.merchantStatement.historyLocked":
    "Kinahanglan ang Personal extended-history entitlement alang sa mas daan nga settled records.",
  "personal.merchantStatement.historyUnlock": "Ablihi ang rewards",
  "personal.merchantStatement.loadMore": "Load more",
  "personal.merchantStatement.openReceipt": "Ablihi ang receipt",
  "personal.merchantStatement.errorTitle": "Dili ma-load ang activity",
  ...
  "personal.merchantStatement.missingTitle": "Wala makit-an",
  "personal.merchantStatement.missing": "Wala makit-an kini nga linked store activity.",
  ...
  "personal.merchantReceipt.errorTitle": "Dili ma-load ang receipt",
  "personal.merchantReceipt.loadFailed": "Dili ma-load ang receipt. Sulayi pag-usab.",
  "personal.merchantReceipt.missingTitle": "Wala makit-an ang receipt",
  ...
  "personal.rewards.comingSoon":
    "Moabut sa sunod nga update ang reward balance ug redemption. Dinhi usab ang extended history unlock.",
