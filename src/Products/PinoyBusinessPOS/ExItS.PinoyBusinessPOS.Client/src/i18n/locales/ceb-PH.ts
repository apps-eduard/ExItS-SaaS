...
export const cebPH: Record<keyof typeof en, string> = {
  ...
  "diagnostics.globalHint":
    "Kopyaha ang report sa ubos ug i-paste sa support o troubleshooting chat.",
  ...
  "staffAssign.ownerConfirmMessage":
    "Ang Owner nagahatag og bug-os nga POS control. I-assign lang sa trusted nga tawo.",
  ...
  "personal.utang.pendingConfirmationsLede":
    "Ablihi ang shared utang aron kumpirmahon o i-dispute ang gi-rekord sa pikas.",
  ...
  "personal.utang.sendForConfirmationHint":
    "Kinahanglan kumpirmahon sa pikas sa dili pa mausab ang balanse.",
  ...
  "org.notifications.unreadEmptyDetail":
    "Naabot ka na. Balhina ngadto sa Tanan aron tan-awon ang naunang mga pahibalo.",
  ...
  "personal.social.reminderServerHint":
    "Ipadala sa ExItS kini nga pahinumdom isip in-app notification sa gitakdang oras.",
  ...
  "personal.social.notif.customerLinkPreviewGeneric":
    "May tindahan nga nidugang kanimo isip customer ug gusto niyang i-link ang imong ExItS account.",
  ...
  "personal.todo.reminderServerHint":
    "Magpadala ang ExItS og in-app notification niining orasa samtang naka-sign in ka.",
  ...
  "personal.customerLinks.lede":
    "Dawata ang tindahan aron i-link ang imong Personal account isip ilang customer. Balibara kung dili nimo kini nailhan.",
  "personal.customerLinks.listTitle": "Naghulat",
  "personal.customerLinks.cardPrompt":
    "Gusto niining tindahan nga i-link ang imong ExItS account isip ilang customer.",
  "personal.customerLinks.acceptHint":
    "Kung dawaton, mailhan ka sa tindahan para sa mga order ug resibo. Dili kini mohatag og staff access.",
  "personal.customerLinks.emptyTitle": "Walay naghulat nga hangyo sa link",
  "personal.customerLinks.emptyDetail":
    "Kung magpadala ang tindahan og customer link request, makita kini dinhi.",
  ...
  "sell.info.cartNotHeld":
    "Ang quantity sa cart wala pa ma-reserve. Makita gihapon sa ubang register ang committed on-hand hangtod sa checkout.",
  ...
  "customers.createKindLede":
    "Pilia ang walk-in (walay ExItS ID) o i-link ang Personal ExItS identity.",
  ...
  "connected.requestHelp":
    "I-scan ang Business QR sa supplier, i-upload ang QR photo, o i-type ang organization ID (ORG######).",
  ...
  "personal.merchantsLede":
    "Pagpalit sa mga tindahan nga naka-link ka. Wala sa package kini ang public storefront URL.",
  "personal.merchantsEmptyTitle": "Walay naka-konektang tindahan",
  "personal.merchantsEmptyDetail":
    "Kung i-link sa business ang imong Personal account isip customer, makita kini dinhi para makapang-order.",
  ...
  "personal.merchantStatement.missing":
    "Dili pa ma-load ang mga palit alang sa store link niini.",
  "personal.merchantStatement.missingHint":
    "Tingali gipahuman pa sa tindahan ang imong customer link, o wala pay na-record nga baligya sa imong profile. Sulayi pag-usab unya.",
  "personal.merchantStatement.deniedHint":
    "Ang naka-link nga Personal account lang ang makatan-aw niini nga purchase history.",
  "personal.merchantStatement.noActivityTitle": "Wala pay palit",
  "personal.merchantStatement.noActivityDetail":
    "Ang mga baligya, resibo, ug Utang activity gikan niini nga tindahan makita dinhi kung na-record na.",
  "personal.merchantStatement.noActivityHint":
    "Mamalit niini nga tindahan o balik pagkahuman sa sunod nimong in-store purchase.",
  ...
  "personal.orderingUnavailableDetail":
    "Dili dawaton niining store ang online customer orders karon.",
  "personal.orderingUnavailableHint":
    "Balik lang unya, o tan-awa ang imong purchase history niini nga tindahan.",
