...
export const cebPH: Record<keyof typeof en, string> = {
  ...
  "sell.searchPlaceholder": "Pangitaa pinaagi sa ngalan sa produkto, barcode, o SKU",
  ...
  "cashHandling.requireOpening": "Kinahanglan ang cash count sa pag-abli sa shift",
  "cashHandling.requireClosing": "Kinahanglan ang cash count sa pagsira sa shift",
  ...
  "cashHandling.emptyDenomsDetail": "Pwede gihapon nimo i-enter manually ang total cash amount.",
