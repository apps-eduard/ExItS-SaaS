export const en = {
  ...
  "sell.readiness.deviceTitle": "Device setup required",
  "sell.readiness.deviceDetail":
    "This browser must be registered before you can start selling in {branch}.",
  "sell.readiness.deviceHelp":
    "Ask your owner or admin for a registration code, then register this browser for the selected branch.",
  "sell.readiness.registerBrowser": "Register this browser",
  ...
  "sell.midSession.fixDevice": "Register this browser",
