...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "summary.disclaimerTitle": "Disclaimer",
  "summary.disclaimerBody":
    "Ang transaction summary na ito ay ginawa ng ExItS para sa business at customer record purposes. Hindi ito kinakatawan ng ExItS bilang BIR-authorized tax invoice.",
  "summary.saleNumber": "Sale number",
