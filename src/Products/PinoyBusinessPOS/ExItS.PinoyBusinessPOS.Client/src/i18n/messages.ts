export const en = {
  ...
  "home.scope": "Online cash checkout is available; ManualGCash/Utang/Card come later.",
  ...
  "sell.payReadyTitle": "Continue to cash checkout.",
  ...
  "checkout.title": "Cash checkout",
  "checkout.cashLede": "Confirm cash received for this sale. No other payment methods yet.",
...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "home.scope": "Online cash checkout available; ManualGCash/Utang/Card ay susunod.",
  ...
  "sell.payReadyTitle": "Magpatuloy sa cash checkout.",
  ...
  "checkout.title": "Cash checkout",
  "checkout.cashLede":
    "Kumpirmahin ang cash na natanggap para sa sale na ito. Wala pang ibang payment method.",
