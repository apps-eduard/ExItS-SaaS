export const en = {
  ...
  "home.badge": "Ready",
  "home.body":
    "Browser session, CSRF, and workspace binding are active. Catalog search and session cart are available; cash checkout follows in the next package.",
  "home.scope": "Cash checkout and POST sales remain excluded until POS-REACT-IMPL-06.",
...
export const filPH: Record<keyof typeof en, string> = {
  ...
  "home.badge": "Handa",
  "home.body":
    "Aktibo ang browser session, CSRF, at workspace binding. Available na ang catalog search at session cart; cash checkout sa susunod na package.",
  "home.scope": "Excluded pa ang cash checkout at POST sales hanggang POS-REACT-IMPL-06.",
