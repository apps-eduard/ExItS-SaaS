...
test("16 platform users directory screenshots and axe", async ({ page }) => {
  ...
  await page.screenshot({
    path: resolve(screenshotDir, "01-all-accounts-1440x900.png"),
    fullPage: true,
  });
  ...
  await page.screenshot({
    path: resolve(screenshotDir, "02-platform-staff-1440x900.png"),
    fullPage: true,
  });
  ...
  await page.screenshot({
    path: resolve(screenshotDir, "03-all-accounts-375x812.png"),
    fullPage: true,
  });
});
