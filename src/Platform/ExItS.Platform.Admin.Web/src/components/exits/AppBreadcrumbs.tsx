...
export function AppBreadcrumbs() {
  ...
  const settingsSection = parsePlatformSettingsSection(path);
  const isSettingsWorkspace = isPlatformSettingsPath(path);
  ...
  const currentLabel = isOverview
    ? t("nav.overview")
    : isSettingsWorkspace && settingsSection
      ? t(settingsSection.titleKey)
      : isOrgWorkspace
        ? orgName
        ...
        {isOverview ? (
          ...
          <>
            ...
            <li className="flex min-w-0 items-center">
              ...
              <Link className="text-primary hover:underline" to={PLATFORM_SETTINGS_BASE_PATH}>
