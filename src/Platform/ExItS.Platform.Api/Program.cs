...
using ExItS.Platform.Api.Reference;
...
builder.Services.AddScoped<SetGlobalProductImage>();
builder.Services.AddScoped<RemoveGlobalProductImage>();
builder.Services.AddScoped<GetGlobalProductImage>();
builder.Services.AddScoped<ListGlobalProductImageMeta>();
...
builder.Services.AddScoped<SuspendBranch>();
builder.Services.AddScoped<ReactivateBranch>();
builder.Services.AddScoped<SetPrimaryBranch>();
builder.Services.AddScoped<GetBranchCapacity>();
builder.Services.AddScoped<ListBranchManagementSummaries>();
builder.Services.AddScoped<ListBranchStaffAccess>();
builder.Services.AddScoped<ListOrganizationAreas>();
builder.Services.AddScoped<CreateOrganizationArea>();
builder.Services.AddScoped<UpdateOrganizationArea>();
builder.Services.AddScoped<ArchiveOrganizationArea>();
builder.Services.AddScoped<SetBranchArea>();
builder.Services.AddScoped<UpsertBranchDeliveryPolicy>();
builder.Services.AddScoped<PreviewBranchDeliveryFee>();
builder.Services.AddScoped<GetBranchFulfillmentReadiness>();
builder.Services.AddScoped<GetBranchOperatingHours>();
builder.Services.AddScoped<UpsertBranchOperatingHours>();
builder.Services.AddScoped<UpdateBranchFulfillmentSettings>();
builder.Services.AddScoped<SetBranchOnlineOrdersPaused>();
builder.Services.AddScoped<ListBranchDeliveryServiceAreas>();
...
builder.Services.AddScoped<IssueGovernanceStepUpGrant>();
builder.Services.AddScoped<ConsumeGovernanceStepUpGrant>();
...
builder.Services.AddSingleton<IWebHandoffTicketStore, MemoryWebHandoffTicketStore>();
builder.Services.AddScoped<ListWebWorkspaces>();
builder.Services.AddScoped<CreateWebHandoffTicket>();
builder.Services.AddScoped<RedeemWebHandoffTicket>();
...
builder.Services.AddScoped<GetPersonalContact>();
builder.Services.AddScoped<ListPersonalConnectionRequests>();
builder.Services.AddScoped<RequestPersonalConnection>();
builder.Services.AddScoped<AcceptPersonalConnectionRequest>();
builder.Services.AddScoped<DeclinePersonalConnectionRequest>();
builder.Services.AddScoped<RevokePersonalConnectionRequest>();
builder.Services.AddScoped<UnlinkPersonalContact>();
builder.Services.AddScoped<BlockPersonalContact>();
builder.Services.AddScoped<UnblockPersonalContact>();
...
builder.Services.AddScoped<GetPersonalUtangEntry>();
...
builder.Services.AddScoped<EnrollDeviceRecoveryCredential>();
builder.Services.AddScoped<ExchangeDeviceRecoveryCredential>();
builder.Services.AddScoped<RevokeDeviceRecoveryCredential>();
...
builder.Services.AddScoped<GetCallerBranchAccessScope>();
...
builder.Services.AddScoped<CreateOrganizationInvitationForPersonal>();
...
builder.Services.AddScoped<ResolveOwnershipTransferTarget>();
builder.Services.AddScoped<RequestOwnershipTransfer>();
builder.Services.AddScoped<CancelOwnershipTransfer>();
builder.Services.AddScoped<AcceptOwnershipTransfer>();
builder.Services.AddScoped<DeclineOwnershipTransfer>();
builder.Services.AddScoped<GetPendingOwnershipTransferForOrg>();
builder.Services.AddScoped<ListPendingOwnershipTransfersForRecipient>();
builder.Services.AddScoped<GetOrganizationSalesDocumentCapability>();
builder.Services.AddScoped<EnsureOrganizationSalesDocumentCapability>();
builder.Services.AddScoped<EnsureTaxDocumentIssuanceAllowed>();
builder.Services.AddScoped<RequestTaxDocumentIssuance>();
builder.Services.AddScoped<GetOrganizationComplianceStatus>();
...
builder.Services.AddScoped<GetOrganizationOnlineSupplierPaymentsCapability>();
builder.Services.AddScoped<EnsureOrganizationOnlineSupplierPaymentsCapability>();
builder.Services.AddScoped<SetOrganizationOnlineSupplierPaymentsCapability>();
...
builder.Services.AddScoped<UpdateOrganizationRegisteredTaxpayerInfo>();
builder.Services.AddScoped<UpsertBranchComplianceProfile>();
builder.Services.AddScoped<GetBranchComplianceProfile>();
builder.Services.AddScoped<ListBranchComplianceProfiles>();
builder.Services.AddScoped<ListComplianceRegistrationRecords>();
builder.Services.AddScoped<AddComplianceRegistrationRecord>();
builder.Services.AddScoped<UpdateComplianceRegistrationRecord>();
builder.Services.AddScoped<ReviewComplianceRegistrationRecord>();
builder.Services.AddScoped<GetComplianceActivationReadiness>();
builder.Services.AddScoped<SubmitComplianceReadinessForReview>();
builder.Services.AddSingleton<ISalesDocumentEducationVersionProvider, SalesDocumentEducationVersionProvider>();
builder.Services.AddScoped<GetSalesDocumentEducationStatus>();
builder.Services.AddScoped<AcknowledgeSalesDocumentEducation>();
...
builder.Services.AddScoped<RemindCustomerLinkRequest>();
builder.Services.AddScoped<RevokeCustomerLinkRequest>();
builder.Services.AddScoped<DeclineCustomerLinkRequest>();
builder.Services.AddScoped<DeclineCustomerLinkRequestById>();
...
builder.Services.AddScoped<DisconnectPersonalLinkedMerchant>();
...
builder.Services.AddScoped<EvaluateCurrentSessionProductAccess>();
...
builder.Services.AddScoped<CreatePendingSubscriptionPayment>();
builder.Services.AddScoped<GetSubscriptionPaymentTransaction>();
builder.Services.AddScoped<ProcessSubscriptionPaymentSimulator>();
builder.Services.AddScoped<ListSubscriptionPaymentTransactions>();
builder.Services.AddScoped<SelectSubscriptionPaymentChannel>();
builder.Services.AddScoped<RetrySubscriptionPayment>();
builder.Services.AddScoped<AttachAndActivatePaidSubscriptionPayment>();
...
app.MapOnlineSupplierPaymentsCapabilityEndpoints();
app.MapSalesDocumentEducationEndpoints();
app.MapOrganizationComplianceProfileEndpoints();
...
app.MapSubscriptionPaymentEndpoints();
